...
!function(t,e,o,n){"use strict";function i(t){var e={};return e=t.__proto__?Object.assign(i(t.__proto__),t):Object.assign({schema:{},dependencies:[]},t),t.schema&&Object.assign(e.schema,t.schema),t.dependencies&&(o=e.dependencies).push.apply(o,t.dependencies),e;var o}function r(t,e){AFRAME.registerComponent(t,i(new e(!0)))}function s(t,e){AFRAME.registerSystem(t,i(new e(!0)))}function a(t,e,o){return 0===e.length?o:(t[e[0]]=a(t[e[0]]||{},e.slice(1),o),t)}function c(t){return t?encodeURIComponent(t).replace(/\./g,"%2E").replace(/%[A-Z0-9]{2}/g,"-"):null}function l(){var t=document.querySelector("link[rel=canonical]");return t?t.href:window.location.href}function h(t,e,o){return c(e||o)+":"+c(t||"")}function d(t){function n(){var e={},o=h(t.appId,t.authorId,ft);e.app=a.child(o).child("app"),e.space=p?e.app.child("spaces").child(p):null,e.user=d?e.app.child("users").child(d):null;var n=e.app.child("instances");return l?e.instance=n.child(l):(e.instance=n.push(),l=e.instance.key()),e}function i(){r.query["altspace-sync-instance"]||(r.query["altspace-sync-instance"]=l,window.location.href=r.toString())}t=t||{};var r=new o,s=t.baseRefUrl||"https://altspace-apps.firebaseio.com/apps/examples/",a=new e(s),l=t.instanceId||r.query["altspace-sync-instance"],p=t.spaceId||r.query["altspace-sync-space"],d=t.userId||r.query["altspace-sync-user"];if(!t.appId||!t.authorId)throw new Error("Both the appId and authorId must be provided to connect.");var u=[];return ut&&(p||u.unshift(altspace.getSpace()),d||u.unshift(altspace.getUser())),Promise.all(u).then(function(t){ut&&(p||(p=t.pop().sid),d||(d=t.pop().userId)),p=c(p),d=c(d),l=c(l);var e=n();return i(),e})}function u(t,e,o){if(!t||!t instanceof THREE.Scene)throw new TypeError("Requires THREE.Scene argument");if(!e||!e instanceof THREE.Camera)throw new TypeError("Requires THREE.Camera argument");ct=t,lt=e,p=o||{},pt=p.renderer&&p.renderer.domElement||window,pt.addEventListener("mousedown",f,!1),pt.addEventListener("mouseup",y,!1),pt.addEventListener("mousemove",v,!1)}function f(t){var e=b(t);if(e&&e.point){var o=g("cursordown",e);e.object.dispatchEvent(o)}}function y(t){var e=b(t),o=g("cursorup",e);e?e.object.dispatchEvent(o):ct.dispatchEvent(o)}function v(t){var e=b(t),o=g("cursormove",e);ct.dispatchEvent(o);var n=e?e.object:null;ht!=n&&(ht&&(o=g("cursorleave",e),ht.dispatchEvent(o)),n&&(o=g("cursorenter",e),n.dispatchEvent(o)),ht=n)}function g(t,e){return{type:t,bubbles:!0,target:e?e.object:null,ray:{origin:vt.ray.origin.clone(),direction:vt.ray.direction.clone()},point:e?e.point.clone():null}}function b(t){var e=new THREE.Vector2;e.x=t.offsetX/(pt.width||pt.innerWidth)*2-1,e.y=2*-(t.offsetY/(pt.height||pt.innerHeight))+1,vt.setFromCamera(e,lt);var o=vt.intersectObjects(ct.children,!0);return o.find(function(t){return!t.object.userData||!t.object.userData.altspace||!t.object.userData.altspace.collider||t.object.userData.altspace.collider.enabled!==!1})||null}function m(){var t,e=[],o=[],n=[],i=0;return{objUrls:e,mtlUrls:o,objects:n,error:t,objectsLoaded:i}}function j(t){var e=t||{};Et=e.TRACE||!1,e.crossOrigin&&(wt=e.crossOrigin),e.baseUrl&&(_t=e.baseUrl),"/"!==_t.slice(-1)&&(_t+="/"),jt=new altspace.utilities.shims.OBJMTLLoader,jt.crossOrigin=wt,Et&&console.log("MultiLoader initialized with params",t)}function E(t,e){var o=t,n=Date.now();if(!o||!o instanceof m)throw new Error("MultiLoader.load expects first arg of type LoadRequest");if(!e||"function"!=typeof e)throw new Error("MultiLoader.load expects second arg of type function");if(!o.objUrls||!o.mtlUrls||o.objUrls.length!==o.mtlUrls.length)throw new Error("MultiLoader.load called with bad LoadRequest");var i=o.objUrls.length;Et&&console.log("Loading models...");for(var r=0;r<i;r++){var s=function(t,o){var r=_t+t.objUrls[o],s=_t+t.mtlUrls[o];Et&&console.log("Loading obj:"+r+", mtl:"+s),jt.load(r,s,function(r){if(t.objects[o]=r,t.objectsLoaded++,t.objectsLoaded===i){var s=((Date.now()-n)/1e3).toFixed(2);Et&&console.log("Loaded "+i+" models in "+s+" seconds"),e()}},_,function(){var e=xhr.target.responseURL||"";t.error="Error loading file "+e})};s(o,r)}}function _(t){if(t.lengthComputable&&t.target.responseURL){var e=t.loaded/t.total*100,o=t.target.responseURL.split("/").pop();Et&&console.log("..."+o+" "+Math.round(e,2)+"% downloaded")}}function w(){console.log("In a tile: "+Tt),console.log("In VR: "+St)}function O(){if(!Tt&&St);else{var t=document.createElement("style");t.type="text/css",t.innerHTML="@import url(https://fonts.googleapis.com/css?family=Open+Sans:800);.altspace-info{text-align:center;font-family:'Open Sans',sans-serif;line-height:.5}.altspace-vr-notice{color:rgba(0,0,0,.7);font-size:5vw}.altspace-pen-name{font-size:7vw}",document.head.appendChild(t),document.body.style.background=n.make_color({seed:S()});var e=document.createElement("div");e.className="altspace-info",document.body.appendChild(e);var o=document.createElement("span");if(o.className="altspace-pen-name",o.innerHTML="<p>"+Rt.toUpperCase()+"</p>",e.appendChild(o),Tt){var i="VR mode does not support preview tiles. Stopping code execution.";throw console.log("ERROR: "+i),new Error(i)}if(!St){var r=document.createElement("span");r.className="altspace-vr-notice",r.innerHTML="<p>View</p>",e.insertBefore(r,o);var s=document.createElement("span");s.className="altspace-vr-notice",s.innerHTML='<p>in <a href="http://altvr.com"> AltspaceVR </a></p>',e.appendChild(s);var i="Not in VR mode. Stopping code execution.";throw Tt&&console.log("ERROR: "+i),new Error(i)}}}function R(t){Rt=t}function T(){var t=document.querySelector("link[rel=canonical]"),e=t?t.href:window.location.href;return new o(e)}function S(){var t=T(),e=t.path.split("/"),o=e[e.length-1];return o}function C(){var t=T(),e=t.path.split("/"),o="team"==e[1],n=o?"team-"+e[2]:e[1];return n}function L(t){var e,o,n=this;if(t.bubbles&&(t.currentTarget=this,t.stopPropagation=function(){e=!0},t.stopImmediatePropagation=function(){o=!0}),this._listeners){var i=this._listeners,r=i[t.type];if(r){t.target=t.target||this;for(var s=[],a=r.length,c=0;c<a;c++)s[c]=r[c];for(var c=0;c<a;c++)if(s[c].call(n,t),o)return}}t.bubbles&&this.parent&&this.parent.dispatchEvent&&!e&&L.call(this.parent,t)}function I(t){t.updateMatrixWorld();var e=new THREE.Vector3;return e.setFromMatrixPosition(t.matrixWorld),e}function x(t){return new Promise(function(e,o){var n=null;return t.traverse(function(t){if("TrackingSkeleton"===t.type)return void(n=t)}),n?e(n):void altspace.getThreeJSTrackingSkeleton().then(function(o){return n=o,t.add(n),e(n)})})}function D(t,e){if(t===e)return!0;if(Array.isArray(t)&&Array.isArray(e)&&t.length===e.length)return t.every(function(o,n){return D(t[n],e[n])});if(t instanceof Object&&e instanceof Object&&D(Object.keys(t).sort(),Object.keys(e).sort())){for(var o in t)if(!D(t[o],e[o]))return!1;return!0}return!1}function M(){oe.forEach(function(t){return t.autoSend()})}function A(t,e){var o=function(n,i){var r=altspace.getGamepads().find(function(e){return"steamvr"===e.mapping&&e.hand===t});r?(e.logging&&console.log("SteamVR input device found",r),n(r)):(e.logging&&console.log("SteamVR input device not found trying again in 500ms..."),setTimeout(o,500,n,i))};return new Promise(o)}e="default"in e?e.default:e,o="default"in o?o.default:o,n="default"in n?n.default:n;var H=function(){},k={schema:{}};k.schema.get=function(){return null},H.prototype.init=function(){},H.prototype.tick=function(t,e){},H.prototype.pause=function(){},H.prototype.play=function(){},Object.defineProperties(H.prototype,k);var P=function(t){function e(){t.apply(this,arguments)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.update=function(t){},e.prototype.remove=function(){},e.prototype.updateSchema=function(t){},e}(H),B=function(t){function e(){t.apply(this,arguments)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{enabled:{type:"boolean",default:"true"}}},e.prototype.init=function(){var t=this;this.setColliderFlag(this.data.enabled),this.el.addEventListener("model-loaded",function(){t.setColliderFlag(t.data.enabled)}.bind(this))},e.prototype.update=function(){this.setColliderFlag(this.data.enabled)},e.prototype.setColliderFlag=function(t){var e=this.el.object3D;e&&(console.log("Setting collider flag to",t),a(e.userData,["altspace","collider","enabled"],t),e.traverse(function(e){e instanceof THREE.Mesh&&a(e.userData,["altspace","collider","enabled"],t)}))},Object.defineProperties(e.prototype,o),e}(P),N=function(t){function e(){t.apply(this,arguments)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.init=function(){this.gamepadIndex=null,this.trackedControlsSystem=document.querySelector("a-scene").systems["tracked-controls"],this.systemGamepads=0,altspace.getGamepads()},e.prototype.tick=function(){if(this.trackedControlsSystem&&this.systemGamepads!==this.trackedControlsSystem.controllers.length&&window.altspace&&altspace.getGamepads&&altspace.getGamepads().length){var t=this.el.components;t["paint-controls"]&&(this.gamepadIndex="left"===t["paint-controls"].data.hand?2:1),null===this.gamepadIndex&&t["hand-controls"]&&(this.gamepadIndex="left"===t["hand-controls"].data?2:1),null===this.gamepadIndex&&t["vive-controls"]&&(this.gamepadIndex="left"===t["vive-controls"].data.hand?2:1),null===this.gamepadIndex&&t["tracked-controls"]&&(this.gamepadIndex=t["tracked-controls"].data.controller),this.el.setAttribute("tracked-controls","id",altspace.getGamepads()[this.gamepadIndex].id),this.el.setAttribute("tracked-controls","controller",0),this.systemGamepads=this.trackedControlsSystem.controllers.length}},e}(P),z=function(t){function e(){t.apply(this,arguments)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{usePixelScale:{type:"boolean",default:"false"},verticalAlign:{type:"string",default:"middle"},enclosuresOnly:{type:"boolean",default:"true"},fullspace:{type:"boolean",default:"false"}}},e.prototype.init=function(){return this.version="AFRAME_ALTSPACE_VERSION",!this.el.object3D instanceof THREE.Scene?void console.warn("aframe-altspace-component can only be attached to a-scene"):void(window.altspace&&window.altspace.inClient?(this.el.setAttribute("vr-mode-ui",{enabled:!1}),this.initRenderer(),this.initCursorEvents(),this.initCollisionEvents()):console.warn("aframe-altspace-component only works inside of AltspaceVR"))},e.prototype.tick=function(t,e){this.el.object3D.updateAllBehaviors&&this.el.object3D.updateAllBehaviors()},e.prototype.initRenderer=function(){var t=this,e=this.el.object3D;altspace.getEnclosure().then(function(n){switch(t.data.fullspace&&(n.requestFullspace(),n.addEventListener("fullspacechange",function(){e.scale.setScalar(n.pixelsPerMeter)})),t.data.usePixelScale&&!t.data.fullspace||e.scale.setScalar(n.pixelsPerMeter),t.data.verticalAlign){case"bottom":e.position.y-=n.innerHeight/2;break;case"top":e.position.y+=n.innerHeight/2;break;case"middle":break;default:console.warn("Unexpected value for verticalAlign: ",t.data.verticalAlign)}t.data.enclosuresOnly&&1===n.innerDepth&&(t.el.renderer.render(new THREE.Scene),t.el.renderer=t.el.effect=o)}.bind(this));var o=this.el.renderer,n=this.el.renderer=this.el.effect=altspace.getThreeJSRenderer({aframeComponentVersion:this.version}),i=function(){};n.setSize=i,n.setPixelRatio=i,n.setClearColor=i,n.clear=i,n.enableScissorTest=i,n.setScissor=i,n.setViewport=i,n.getPixelRatio=i,n.getMaxAnisotropy=i,n.setFaceCulling=i,n.context={canvas:{}},n.shadowMap={}},e.prototype.initCursorEvents=function(){function t(t,e){var n=e.target.el;o&&o.emit(t,{target:n,ray:e.ray,point:e.point}),n&&n.emit(t,{target:n,ray:e.ray,point:e.point})}var e=this.el.object3D,o=document.querySelector("a-cursor")||document.querySelector("a-entity[cursor]");o&&(o.setAttribute("material","transparent",!0),o.setAttribute("material","opacity",0));var n=null;e.addEventListener("cursordown",function(e){n=e.target,t("mousedown",e)}),e.addEventListener("cursorup",function(e){t("mouseup",e),e.target.uuid===n.uuid&&t("click",e),n=null}),e.addEventListener("cursorenter",function(e){e.target.el&&(e.target.el.addState("hovered"),o&&o.addState("hovering"),t("mouseenter",e))}),e.addEventListener("cursorleave",function(e){e.target.el&&(e.target.el.removeState("hovered"),o&&o.removeState("hovering"),t("mouseleave",e))})},e.prototype.initCollisionEvents=function(){function t(t,e){var o=e.target.el;o&&(e.target=o,e.other&&e.other.el&&(e.other=e.other.el),o.emit(t,e))}var e=this.el.object3D;e.addEventListener("collisionenter",function(e){t("collisionenter",e)}),e.addEventListener("collisionexit",function(e){t("collisionexit",e)}),e.addEventListener("triggerenter",function(e){t("triggerenter",e)}),e.addEventListener("triggerexit",function(e){t("triggerexit",e)})},Object.defineProperties(e.prototype,o),e}(P),U=function(t){function e(){t.apply(this,arguments)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={dependencies:{}};return o.dependencies.get=function(){return["sync"]},e.prototype.init=function(){this.sync=this.el.components.sync,this.sync.isConnected?start():this.el.addEventListener("connected",this.start.bind(this))},e.prototype.start=function(){var t=this.sync.dataRef.child("material/color"),e=!1,o=!0;this.el.addEventListener("componentchanged",function(o){var n=o.detail.name,i=o.detail.oldData,r=o.detail.newData;"material"===n&&!e&&i.color!==r.color&&sync.isMine&&setTimeout(function(){return t.set(r.color)},0)});var n=this;t.on("value",function(t){if(!n.sync.isMine||o){var i=t.val();e=!0,n.el.setAttribute("material","color",i),e=!1,o=!1}})},Object.defineProperties(e.prototype,o),e}(P),V=function(t){function e(t){void 0===t&&(t=!1),this._isComponent=t,this.scene=void 0,this.syncSys=void 0,this.ref=void 0,this.key=void 0,this.dataRef=void 0,this.ownerRef=void 0,this.ownerId=void 0,this.isConnected=!1,this.isMine=!1}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{mode:{default:"link"},ownOn:{type:"string"}}},e.prototype.init=function(){var t=this;if(this.scene=this.el.sceneEl,this.syncSys=this.scene.systems["sync-system"],this.syncSys.isConnected?start():this.scene.addEventListener("connected",this.start.bind(this)),this.data.ownOn){var e=this.data.ownOn.split(/[ ,]+/);e.forEach(function(e){t.el.addEventListener(e,function(){t.isConnected&&t.takeOwnership()}.bind(t))}.bind(this))}},e.prototype.takeOwnership=function(){this.ownerRef.set(this.syncSys.clientId),this.ownerRef.onDisconnect().set(null)},e.prototype.start=function(){var t=this;if(this.scene.addEventListener("clientleft",function(e){var o=(!ownerId||ownerId===e.detail.id)&&t.syncSys.isMasterClient;o&&t.takeOwnership()}.bind(this)),"link"!==this.data.mode)return void console.error("Unsupported sync mode: "+this.data.mode);var e=this.el.id;return e?(console.log("syncSys: "+this.syncSys),console.log("syncSys.sceneRef: "+this.syncSys.sceneRef),this.link(this.syncSys.sceneRef.child(e)),this.setupReceive(),this.isConnected=!0,void this.el.emit("connected",null,!1)):void console.error("Entities cannot be synced using link mode without an id.")},e.prototype.link=function(t){this.ref=t,this.key=this.ref.key(),this.dataRef=this.ref.child("data"),this.ownerRef=this.ref.child("owner")},e.prototype.setupReceive=function(){var t=this;this.ownerRef.transaction(function(e){if(!e)return t.ownerRef.onDisconnect().set(null),t.syncSys.clientId}.bind(this)),this.ownerRef.on("value",function(e){var o=e.val(),n=o===t.syncSys.clientId&&!t.isMine;n&&t.el.emit("ownershipgained",null,!1);var i=o!==t.syncSys.clientId&&t.isMine;i&&(t.el.emit("ownershiplost",null,!1),t.ownerRef.onDisconnect().cancel()),t.ownerId=o,t.isMine=o===t.syncSys.clientId}.bind(this))},Object.defineProperties(e.prototype,o),e}(P),q=function(t){function e(){t.apply(this,arguments)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{author:{type:"string",default:null},app:{type:"string",default:null},instance:{type:"string",default:null},refUrl:{type:"string",default:null}}},e.prototype.init=function(){return this.data&&this.data.app?(console.log(this.data),this.isConnected=!1,void altspace.utilities.sync.connect({authorId:this.data.author,appId:this.data.app,instanceId:this.data.instance,baseRefUrl:this.data.refUrl}).then(this.connected.bind(this))):void console.warn("The sync-system must be present on the scene and configured with required data.")},e.prototype.connected=function(t){this.connection=t,this.sceneRef=this.connection.instance.child("scene"),this.clientsRef=this.connection.instance.child("clients"),this.clientId=this.sceneEl.object3D.uuid,this.masterClientId=null;var e=this;this.clientsRef.on("value",function(t){var o=t.val(),n=Object.keys(o)[0];e.masterClientId=o[n]}),this.clientsRef.on("child_added",function(t){var o=t.val();setTimeout(function(){e.sceneEl.emit("clientjoined",{id:o},!1)},0)}),this.clientsRef.on("child_removed",function(t){var o=t.val();setTimeout(function(){e.sceneEl.emit("clientleft",{id:o},!1)},0)}),this.clientsRef.push(this.clientId).onDisconnect().remove(),this.connection.instance.child("initialized").once("value",function(t){var o=!t.val();t.ref().set(!0),e.sceneEl.emit("connected",{shouldInitialize:o},!1),e.isConnected=!0})},e.prototype.isMasterClient=function(){return this.masterClientId===this.clientId},Object.defineProperties(e.prototype,o),e}(H);AFRAME.registerComponent("sync-transform",{dependencies:["sync"],schema:{},init:function(){function t(){function t(t,n){if(!o.isMine){var i=t.val();i&&e.el.setAttribute(n,i)}}function n(t){if(o.isMine){var e=t.detail.name,n=t.detail.newData;if("position"===e)l(n);else if("rotation"===e)p(n);else{if("scale"!==e)return;h(n)}}}function i(t,e,o){var n,i,r,s,a=0;o||(o={});var c=function(){a=o.leading===!1?0:Date.now(),n=null,s=t.apply(i,r),n||(i=r=null)},l=function(){var l=Date.now();a||o.leading!==!1||(a=l);var p=e-(l-a);return i=this,r=arguments,p<=0||p>e?(n&&(clearTimeout(n),n=null),a=l,s=t.apply(i,r),n||(i=r=null)):n||o.trailing===!1||(n=setTimeout(c,p)),s};return l.cancel=function(){clearTimeout(n),a=0,n=i=r=null},l}var r=o.dataRef.child("position"),s=o.dataRef.child("rotation"),a=o.dataRef.child("scale");e.updateRate=100;var c=[];e.el.addEventListener("ownershiplost",function(){for(var t=e.el.children,o=0;o<t.length;o++){var n=t[o].tagName.toLowerCase();"a-animation"===n&&(c.push(t[o]),t[o].stop())}}),e.el.addEventListener("ownershipgained",function(){for(var t=0;t<c.length;t++){var e=c[t];e.start()}c=[]}),r.on("value",function(e){t(e,"position")}),s.on("value",function(e){t(e,"rotation")}),a.on("value",function(e){t(e,"scale")});var l=i(function(t){r.set(t)},e.updateRate),p=i(function(t){s.set(t)},e.updateRate),h=i(function(t){a.set(t)},e.updateRate);e.el.addEventListener("componentchanged",n)}var e=this,o=e.el.components.sync;o.isConnected?t():e.el.addEventListener("connected",t)}});var F=function(t){function e(){t.apply(this,arguments)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={dependencies:{}};return o.dependencies.get=function(){return["sync"]},e.prototype.init=function(){this.sync=this.el.components.sync,this.scene=this.el.sceneEl,this.syncSys=this.scene.systems["sync-system"],this.soundStateRef=null,this.soundEventRef=null,this.sync.isConnected?this.start():this.el.addEventListener("connected",this.start.bind(this))},e.prototype.remove=function(){this.soundStateRef.off("value"),this.soundEventRef.off("value")},e.prototype.start=function(){function t(t){if(this.sync.isMine){var t={type:t.type,sender:this.syncSys.clientId,el:this.el.id,time:Date.now()};this.soundEventRef.set(t)}}var e=this;this.soundStateRef=this.sync.dataRef.child("sound/state"),this.soundEventRef=this.sync.dataRef.child("sound/event"),this.el.addEventListener("sound-played",t.bind(this)),this.el.addEventListener("sound-paused",t.bind(this)),this.soundEventRef.on("value",function(t){if(!e.sync.isMine){var o=t.val();if(o&&o.el===e.el.id){var n=e.el.components["n-sound"];"sound-played"===o.type?n.playSound():n.pauseSound()}}}.bind(this)),this.el.addEventListener("componentchanged",function(t){if(e.sync.isMine){var o=t.detail.name;"n-sound"===o&&e.soundStateRef.set(t.detail.newData)}}.bind(this)),this.soundStateRef.on("value",function(t){if(!e.sync.isMine){var o=t.val();o&&e.el.setAttribute("n-sound",o)}}.bind(this))},Object.defineProperties(e.prototype,o),e}(P),G=function(t){function e(){this.multiple=!0,this.actOnTargets=function(){function t(t){this.data.emit&&t.emit(this.data.emit),this.data.gain&&t.addState(this.data.gain),this.data.lose&&t.removeState(this.data.lose)}this.data.targets&&this.data.targets.forEach(t.bind(this)),this.data.target&&t.call(this,this.data.target)}.bind(this),this.actOnTargetsIfStateMatches=function(t){var e=t.detail.state;e!==this.data.gained&&e!==this.data.lost||this.actOnTargets()}.bind(this)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{on:{type:"string"},emit:{type:"string"},gained:{type:"string"},lost:{type:"string"},gain:{type:"string"},lose:{type:"string"},targets:{type:"selectorAll"},target:{type:"selector"}}},e.prototype.update=function(t){t.on&&this.el.removeEventListener(t.on,this.actOnTargets),t.gained&&this.el.removeEventListener("stateadded",this.actOnTargetsIfStateMatches),t.lost&&this.el.removeEventListener("stateremoved",this.actOnTargetsIfStateMatches),this.data.on&&this.el.addEventListener(this.data.on,this.actOnTargets),this.data.gained&&this.el.addEventListener("stateadded",this.actOnTargetsIfStateMatches),this.data.lost&&this.el.addEventListener("stateremoved",this.actOnTargetsIfStateMatches)},e.prototype.remove=function(){this.el.removeEventListener(this.data.on,this.actOnTargets),this.el.removeEventListener("stateadded",this.actOnTargetsIfStateMatches),this.el.removeEventListener("stateremoved",this.actOnTargetsIfStateMatches)},Object.defineProperties(e.prototype,o),e}(P);if(!window.altspace||!altspace.inClient){var W=function(){};a(window,["altspace","addNativeComponent"],W),a(window,["altspace","updateNativeComponent"],W),a(window,["altspace","removeNativeComponent"],W)}var J=new THREE.BoxGeometry(.001,.001,.001),X=new THREE.MeshBasicMaterial({color:0});X.visible=!1;var Y=function(t){function e(){t.call(this,J,X)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e}(THREE.Mesh),Q=function(t){function e(t){this.name=t}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.init=function(){var t=this.mesh||this.el.getOrCreateObject3D("mesh",Y);t.userData.altspace=t.userData.altspace||{},t.userData.altspace.collider=t.userData.altspace.collider||{},t.userData.altspace.collider.enabled=!1,altspace.addNativeComponent(t,this.name),this.update(this.data)},e.prototype.update=function(){var t=this.mesh||this.el.object3DMap.mesh;altspace.updateNativeComponent(t,this.name,this.data)},e.prototype.remove=function(){var t=this.mesh||this.el.object3DMap.mesh;altspace.removeNativeComponent(t,this.name)},e.prototype.callComponent=function(t){for(var e=[],o=arguments.length-1;o-- >0;)e[o]=arguments[o+1];var n=this.mesh||this.el.object3DMap.mesh;altspace.callNativeComponent(n,this.name,t,e)},e}(P),Z=function(t){function e(){t.call(this,"n-object")}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{res:{type:"string"}}},Object.defineProperties(e.prototype,o),e}(Q),K=function(t){function e(){t.call(this,"n-spawner")}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{res:{type:"string"}}},Object.defineProperties(e.prototype,o),e}(Q),$=function(t){function e(){t.call(this,"n-text")}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{text:{default:"",type:"string"},fontSize:{default:"10",type:"int"},width:{default:"10",type:"number"},height:{default:"1",type:"number"},horizontalAlign:{default:"middle"},verticalAlign:{default:"middle"}}},Object.defineProperties(e.prototype,o),e}(Q),tt=function(t){function e(){t.call(this,"n-billboard")}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e}(Q),et=function(t){function e(){t.apply(this,arguments)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{center:{type:"vec3"},type:{type:"string",default:"object"},isTrigger:{default:!1,type:"boolean"}}},Object.defineProperties(e.prototype,o),e}(Q),ot=function(t){function e(){t.call(this,"n-sphere-collider")}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{radius:{default:"0.001",type:"number"}}},Object.defineProperties(e.prototype,o),e}(et),nt=function(t){function e(){t.call(this,"n-box-collider")}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{size:{type:"vec3",default:"1 1 1"}}},Object.defineProperties(e.prototype,o),e}(et),it=function(t){function e(){t.call(this,"n-capsule-collider")}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{radius:{default:"0",type:"number"},height:{default:"0",type:"number"},direction:{default:"y"}}},Object.defineProperties(e.prototype,o),e}(et),rt=function(t){function e(e){void 0===e&&(e=null),t.call(this,"n-mesh-collider"),this.mesh=e,this.subcomponents=[]}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{convex:{type:"boolean",default:"true"}}},e.prototype.init=function(){var o=this;if(this.mesh)t.prototype.init.call(this);else{this.subcomponents=[];var n=this.el.object3DMap.mesh;n.traverse(function(t){if(t instanceof THREE.Mesh){var n=new e(t);o.subcomponents.push(n),n.init()}}.bind(this)),this.el.addEventListener("model-loaded",this.init.bind(this))}},e.prototype.update=function(e){var o=this;this.mesh?t.prototype.update.call(this,e):this.subcomponents.forEach(function(t){t.data=o.data,t.update(e)}.bind(this))},e.prototype.remove=function(){this.mesh?t.prototype.remove.call(this):this.subcomponents.forEach(function(t){t.remove()}.bind(this))},Object.defineProperties(e.prototype,o),e}(et),st=function(t){function e(){t.call(this,"n-container")}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{capacity:{default:4,type:"number"}}},e.prototype.init=function(){t.prototype.init.call(this);var e=this.el,o=this;e.addEventListener("stateadded",function(t){"container-full"===t.detail.state&&e.emit("container-full"),"container-empty"===t.detail.state&&e.emit("container-empty")}),e.addEventListener("container-count-changed",function(t){o.count=t.detail.count})},Object.defineProperties(e.prototype,o),e}(Q),at=function(t){function e(){t.call(this,"n-sound")}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={schema:{}};return o.schema.get=function(){return{on:{type:"string"},res:{type:"string"},src:{type:"string"},loop:{type:"boolean"},volume:{type:"number",default:1},autoplay:{type:"boolean"},oneshot:{type:"boolean"},spatialBlend:{type:"float",default:1},pitch:{type:"float",default:1},minDistance:{type:"float",default:1},maxDistance:{type:"float",default:12},rolloff:{type:"string",default:"logarithmic"}}},e.prototype.init=function(){var e=this.data.src;if(e&&!e.startsWith("http"))if(e.startsWith("/"))this.data.src=location.origin+e;else{var o=location.pathname;o.endsWith("/")||(o=location.pathname.split("/").slice(0,-1).join("/")+"/"),this.data.src=location.origin+o+e}t.prototype.init.call(this)},e.prototype.update=function(e){t.prototype.update.call(this,e),this.playHandler&&this.el.removeEventListener(e.on,this.playHandler),this.data.on&&(this.playHandler=this.playSound.bind(this),this.el.addEventListener(this.data.on,this.playHandler))},e.prototype.remove=function(){t.prototype.remove.call(this),this.playHandler&&this.el.removeEventListener(oldData.on,this.playHandler)},e.prototype.pauseSound=function(){this.callComponent("pause"),this.el.emit("sound-paused")},e.prototype.playSound=function(){this.callComponent("play"),this.el.emit("sound-played")},e.prototype.seek=function(t){this.callComponent("seek",{time:t})},Object.defineProperties(e.prototype,o),e}(Q);window.AFRAME&&(r("altspace-cursor-collider",B),r("altspace-tracked-controls",N),r("altspace",z),s("sync-system",q),r("sync-color",U),r("sync",V),r("sync-n-sound",F),r("wire",G),r("n-object",Z),r("n-spawner",K),r("n-text",$),r("n-billboard",tt),r("n-container",st),r("n-sound",at),r("n-sphere-collider",ot),r("n-box-collider",nt),r("n-capsule-collider",it),r("n-mesh-collider",rt));var ct,lt,pt,ht,dt=Object.freeze({AltspaceComponent:z,AltspaceCursorCollider:B,AltspaceTrackedControls:N,SyncSystem:q,SyncComponent:V,SyncColor:U,SyncNSound:F,Wire:G,NObject:Z,NSpawner:K,NText:$,NBillboard:tt,NContainer:st,NSound:at,NSphereCollider:ot,NBoxCollider:nt,NCapsuleCollider:it,NMeshCollider:rt}),ut=altspace&&altspace.inClient,ft=l(),yt=Object.freeze({connect:d}),vt=new THREE.Raycaster,gt=Object.freeze({init:u});window.altspace=window.altspace||{},window.altspace.utilities=window.altspace.utilities||{};var bt=function(t){var e=t.auto;void 0===e&&(e=!0),this._scene=null,this._renderer=null,this._camera=null;var o=window.AFRAME&&document.querySelector("a-scene");if(o){var n=document.querySelector("a-scene");this._scene=n.object3D,this._renderer=n.renderer;var i=document.querySelector("a-camera");i&&(this._camera=i.object3D)}else window.altspace&&altspace.inClient?(this._scene=new THREE.Scene,this._renderer=altspace.getThreeJSRenderer(),this._camera=new THREE.PerspectiveCamera):this._setupWebGL();e&&!o&&this.loop()},mt={scene:{},renderer:{},camera:{}};bt.prototype._setupWebGL=function(){function t(){n.aspect=window.innerWidth/window.innerHeight,n.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)}var e=this._scene=new THREE.Scene,o=this._renderer=new THREE.WebGLRenderer({antialias:!0}),n=this._camera=new THREE.PerspectiveCamera;document.addEventListener("DOMContentLoaded",function(t){document.body.style.margin="0px",document.body.style.overflow="hidden",o.setClearColor("#035F72");var e=document.createElement("div");document.body.appendChild(e),e.appendChild(o.domElement)}),window.addEventListener("resize",t),t(),n.position.z=500,n.fov=45,n.near=1,n.far=2e3,e.add(n),e.add(new THREE.AmbientLight("white")),this.cursor=u(e,n)},bt.prototype.loop=function(){window.requestAnimationFrame(this.loop.bind(this)),this.scene.updateAllBehaviors&&this.scene.updateAllBehaviors(),this.renderer.render(this.scene,this.camera)},mt.scene.get=function(){return this._scene},mt.renderer.get=function(){return this._renderer},mt.camera.get=function(){return this._camera},Object.defineProperties(bt.prototype,mt);var jt,Et,_t="",wt="",Ot=Object.freeze({init:j,load:E,LoadRequest:m}),Rt="VR CodePen",Tt=window.name&&"pen-"===window.name.slice(0,4),St=!!window.altspace.inClient,Ct=!!location.href.match("codepen.io/"),Lt=Object.freeze({inTile:Tt,inVR:St,inCodePen:Ct,ensureInVR:O,setName:R,getPenId:S,getAuthorId:C,printDebugInfo:w}),It=function(){};
It.prototype.load=function(t,e,o){var n=new THREE.MTLLoader,i=e.split("/").slice(0,-1).join("/");n.setBaseUrl(i+"/"),n.setCrossOrigin(this.crossOrigin),n.load(e,function(e){var n=new THREE.OBJLoader;n.setMaterials(e),n.load(t,o)})},THREE&&!altspace.inClient&&(THREE.EventDispatcher.prototype.dispatchEvent=L,THREE.Object3D.prototype.dispatchEvent=L),THREE.Scene.prototype.updateAllBehaviors=function(){var t=performance.now(),e=this.__lastNow||t,o=t-e,n=this,i=[];this.traverse(function(t){t.__behaviorList&&i.push(t)});for(var r=0,s=i.length;r<s;r++){var a=i[r];a.updateBehaviors(o,n)}this.__lastNow=t},THREE.Object3D.prototype.addBehavior=function(t){this.addBehaviors(t)},THREE.Object3D.prototype.addBehaviors=function(){for(var t=[],e=arguments.length;e--;)t[e]=arguments[e];this.__behaviorList=this.__behaviorList||[],(o=this.__behaviorList).push.apply(o,t);var o},THREE.Object3D.prototype.removeBehavior=function(t){if(!this.__behaviorList||0===this.__behaviorList.length)return null;var e=this.__behaviorList.indexOf(t);if(e!==-1){this.__behaviorList.splice(e,1);try{t.dispose&&t.dispose.call(t,this)}catch(e){console.group(),(console.error||console.log).call(console,e.stack||e),console.log("[Behavior]"),console.log(t),console.log("[Object3D]"),console.log(this),console.groupEnd()}}},THREE.Object3D.prototype.removeAllBehaviors=function(){var t=this;if(!this.__behaviorList||0===this.__behaviorList.length)return null;for(var e=0,o=this.__behaviorList.length;e<o;e++){var n=t.__behaviorList[e];try{n.dispose&&n.dispose.call(n,t)}catch(e){console.group(),(console.error||console.log).call(console,e.stack||e),console.log("[Behavior]"),console.log(n),console.log("[Object3D]"),console.log(t),console.groupEnd()}}this.__behaviorList.length=0},THREE.Object3D.prototype.getBehaviorByType=function(t){var e=this;if(!this.__behaviorList||0===this.__behaviorList.length)return null;for(var o=0,n=this.__behaviorList.length;o<n;o++)if(e.__behaviorList[o].type===t)return e.__behaviorList[o]},THREE.Object3D.prototype.updateBehaviors=function(t,e){var o=this;if(this.__behaviorList&&0!==this.__behaviorList.length){for(var n=[],i=this.__behaviorList.slice(),r=0,s=this.__behaviorList.length;r<s;r++){var a=o.__behaviorList[r];a.__isInitialized||n.push(a)}for(var r=0,s=n.length;r<s;r++){var a=n[r];try{a.awake&&a.awake.call(a,o,e)}catch(t){console.group(),(console.error||console.log).call(console,t.stack||t),console.log("[Behavior]"),console.log(a),console.log("[Object3D]"),console.log(o),console.groupEnd()}}for(var r=0,s=n.length;r<s;r++){var a=n[r];try{a.start&&a.start.call(a)}catch(t){console.group(),(console.error||console.log).call(console,t.stack||t),console.log("[Behavior]"),console.log(a),console.log("[Object3D]"),console.log(o),console.groupEnd()}a.__isInitialized=!0}for(var r=0,s=i.length;r<s;r++){var a=i[r];try{a.update&&a.update.call(a,t)}catch(t){console.group(),(console.error||console.log).call(console,t.stack||t),console.log("[Behavior]"),console.log(a),console.log("[Object3D]"),console.log(o),console.groupEnd()}}}};var xt=Object.freeze({OBJMTLLoader:It,cursor:gt}),Dt=function(){},Mt={type:{}};Mt.type.get=function(){return this._typeWarning||(console.warn("Behavior",this,"does not expose type information!","It will not be queryable by getBehaviorByType, which will break","some built-in behaviors."),this._typeWarning=!0),null},Dt.prototype.awake=function(t,e){},Dt.prototype.start=function(){},Dt.prototype.update=function(t){},Dt.prototype.dispose=function(t){},Object.defineProperties(Dt.prototype,Mt);var At=function(t){function e(t){this.config=Object.assign({x:3,y:5,shouldRotate:!0,shouldMove:!0},t),this.object3d=null,this.offsetPosition=null,this.lastBobPosition=new THREE.Vector3,this.nowOffset=1e4*Math.random()}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"Bob"},e.prototype.awake=function(t){this.object3d=t,this.offsetPosition=object3D.position.clone()},e.prototype.update=function(t){var e=Math.floor(performance.now())+this.nowOffset;this.config.shouldMove&&(this.lastBobPosition.equals(this.object3d.position)||this.offsetPosition.copy(this.object3d.position),this.object3d.position.y+=Math.sin(e/800)*this.config.x,this.object3d.position.x+=Math.sin(e/500)*this.config.y,this.lastBobPosition.copy(this.object3d.position)),this.config.shouldRotate&&(object3d.rotation.x=Math.sin(e/500)/15)},Object.defineProperties(e.prototype,o),e}(Dt),Ht=function(t){function e(t){this.config=Object.assign({overBrightness:1.5,downBrightness:.5},t),this.object3d=null,this.scene=null,this.originalColor=null,this.modifiedColor=new THREE.Color,this._cbs={cursorenter:this.cursorEnter.bind(this),cursordown:this.cursorDown.bind(this),cursorup:this.cursorUp.bind(this),cursorleave:this.cursorLeave.bind(this)}}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"ButtonStateStyle"},e.prototype.awake=function(t,e){this.object3d=t,this.scene=e,this.originalColor=this.config.originalColor||object3d.material.color,this.object3d.addEventListener("cursorenter",this._cbs.cursorenter),this.object3d.addEventListener("cursordown",this._cbs.cursordown)},e.prototype.dispose=function(){this.object3d.removeEventListener("cursorenter",this._cbs.cursorenter),this.object3d.removeEventListener("cursorleave",this._cbs.cursorleave),this.object3d.removeEventListener("cursorup",this._cbs.cursorup),this.object3d.removeEventListener("cursordown",this._cbs.cursordown)},e.prototype.changeBrightness=function(t){this.modifiedColor.set(this.originalColor),this.modifiedColor.multiplyScalar(t),this.modifiedColor.r=THREE.Math.clamp(this.modifiedColor.r,0,1),this.modifiedColor.g=THREE.Math.clamp(this.modifiedColor.g,0,1),this.modifiedColor.b=THREE.Math.clamp(this.modifiedColor.b,0,1),this.object3d.material.color=this.modifiedColor},e.prototype.cursorLeave=function(){this.object3d.removeEventListener("cursorleave",this._cbs.cursorleave),this.changeBrightness(1)},e.prototype.cursorEnter=function(){this.changeBrightness(this.config.overBrightness),object3d.addEventListener("cursorleave",this._cbs.cursorleave)},e.prototype.cursorUp=function(t){this.scene.removeEventListener("cursorup",this._cbs.cursorup),this.object3d.addEventListener("cursorenter",this._cbs.cursorenter),t.target===this.object3d?(this.changeBrightness(this.config.overBrightness),this.object3d.addEventListener("cursorleave",this._cbs.cursorleave)):this.changeBrightness(1)},e.prototype.cursorDown=function(){this.scene.addEventListener("cursorup",this._cbs.cursorup),this.object3d.removeEventListener("cursorleave",this._cbs.cursorleave),this.object3d.removeEventListener("cursorenter",this._cbs.cursorenter),this.changeBrightness(this.config.downBrightness)},Object.defineProperties(e.prototype,o),e}(Dt),kt=function(t){function e(t){this.config=t=Object.assign({space:"world",x:!1,y:!1,z:!1,cursorSnap:!0},t),this.min=new THREE.Vector3(void 0!==t.x.min?t.x.min:Number.NEGATIVE_INFINITY,void 0!==t.y.min?t.y.min:Number.NEGATIVE_INFINITY,void 0!==t.z.min?t.z.min:Number.NEGATIVE_INFINITY),this.max=new THREE.Vector3(void 0!==t.x.max?t.x.max:Number.POSITIVE_INFINITY,void 0!==t.y.max?t.y.max:Number.POSITIVE_INFINITY,void 0!==t.z.max?t.z.max:Number.POSITIVE_INFINITY),this.object3d=null,this.scene=null,this.sync=null,this.intersector=null,this.dragOffset=new THREE.Vector3,this.raycaster=new THREE.Raycaster,this.raycaster.linePrecision=3,this._cbs={startDrag:this.startDrag.bind(this),moveDrag:this.moveDrag.bind(this),stopDrag:this.stopDrag.bind(this)}}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"Drag"},e.prototype.awake=function(t,e){this.object3d=t,this.scene=e,this.sync=t.getBehaviorByType("Object3DSync"),this.makeIntersector(),this.scene.add(this.intersector)},e.prototype.start=function(){this.object3d.addEventListener("cursordown",this._cbs.startDrag)},e.prototype.dispose=function(){this.object3d.removeEventListener("cursordown",this._cbs.startDrag)},e.prototype.makeIntersector=function(){function t(){i.rotateY(Math.PI)}function e(){i.rotateX(Math.PI/2)}function o(){i.rotateY(Math.PI/2)}var n=1e4,i=new THREE.PlaneGeometry(n,n),r=!!this.config.x,s=!!this.config.y,a=!!this.config.z,c=r+s+a;if(3===c)throw new Error("Arbitrary dragging currently unsupported. Please lock at least one axis.");if(2!==c)throw 1===c?new Error("Single axis dragging currently unsupported."):new Error("Invalid axis configuration");r&&s?t():r&&a?e():s&&a&&o();var l=new THREE.MeshBasicMaterial({color:"purple"});l.side=THREE.DoubleSide,this.intersector=new THREE.Mesh(i,l),this.intersector.visible=!1,this.intersector.material.visible=!1},e.prototype.startDrag=function(t){this.scene.addEventListener("cursorup",this._cbs.stopDrag),this.scene.addEventListener("cursormove",this._cbs.moveDrag),this.raycaster.set(t.ray.origin,t.ray.direction);var e=raycaster.intersectObject(object3d,!0)[0];if(e){var o=e.point.clone(),n=I(this.object3d).clone();this.dragOffset.copy(o).sub(n),this.intersector.position.copy(this.intersector.parent.worldToLocal(o)),this.intersector.quaternion.copy(this.object3d.parent.quaternion),this.intersector.updateMatrixWorld();var i=this.createDragEvent("dragstart");this.object3d.dispatchEvent(i)}},e.prototype.moveDrag=function(t){this.sync&&!this.sync.isMine&&this.sync.takeOwnership(),this.intersector.visible=!0,this.raycaster.set(t.ray.origin,t.ray.direction);var e=this.raycaster.intersectObject(this.intersector,!0)[0];if(this.intersector.visible=!1,e){var o=new THREE.Vector3;o.copy(e.point).sub(this.dragOffset);var n=this,i=I(this.object3d);["x","y","z"].filter(function(t){return!n.config[t]}).forEach(function(t){o[t]=i[t]}),o.clamp(min,max),this.object3d.parent.updateMatrixWorld();var r=this.object3d.parent.worldToLocal(o);this.object3d.position.set(this.config.x?r.x:this.object3d.position.x,this.config.y?r.y:this.object3d.position.y,this.config.z?r.z:this.object3d.position.z)}},e.prototype.stopDrag=function(){this.scene.removeEventListener("cursorup",this._cbs.stopDrag),this.scene.removeEventListener("cursormove",this._cbs.moveDrag);var t=this.createDragEvent("dragstop");this.object3d.dispatchEvent(t)},e.prototype.createDragEvent=function(t){return{type:t,bubbles:!0,target:this.object3d,ray:this.raycaster.ray.clone()}},Object.defineProperties(e.prototype,o),e}(Dt),Pt=.2,Bt=function(t){function e(t){this.config=Object.assign({position:!0,rotation:!0,scale:!0},t),this.object3d=null,this.gamepad=null,this.scene=null,this.sync=null,this.isAltModeR=!1,this.isAltModeL=!1,this.prevAltButtonR=!1,this.prevAltButtonL=!1,this.isInitialized=!1,this.originalObj=null}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"GamepadControls"},e.prototype.awake=function(t,e){var o=this;if(this.object3d=t,this.scene=e,this.sync=this.object3d.getBehaviorByType("Object3DSync"),this.originalObj=object3d.clone(),this.gamepad=this.getGamepad(),this.gamepad)console.log("Gamepad detected: "+this.gamepad.id);else var n=setInterval(function(){o.gamepad=o.getGamepad(),o.gamepad&&(console.log("Gamepad connected: "+o.gamepad.id),clearInterval(n))}.bind(this),500);this.scene.addEventListener("cursordown",function(t){o.gamepad&&!o.isInitialized&&(o.preventDefault(o.gamepad),o.isInitialized=!0)}.bind(this))},e.prototype.getGamepad=function(){var t=this,e=[];if(e=altspace&&altspace.inClient?altspace.getGamepads():navigator.getGamepads(),e.length>0)for(var o=0;o<e.length;o++){var n=e[o];if(n&&n.axes&&4===n.axes.length&&n.buttons&&16===n.buttons.length)return altspace&&altspace.inClient&&t.preventDefault(n),n}},e.prototype.preventDefault=function(t){var e=new Array(4).fill(!1),o=new Array(16).fill(!1);this.config.position&&(e[0]=!0,e[1]=!0,o[10]=!0),this.config.rotation&&(e[2]=!0,e[3]=!0,o[11]=!0),this.config.scale&&(o[12]=!0,o[13]=!0),o[8]=!0,t.preventDefault(e,o)},e.prototype.update=function(t){if(altspace&&altspace.inClient||!window.chrome||!this.gamepad||(this.gamepad=this.getGamepad()),this.gamepad){var e=this.gamepad.buttons[8].pressed;if(e)return this.sync.isMine||this.sync.takeOwnership(),this.object3d.position.copy(this.originalObj.position),this.object3d.rotation.copy(this.originalObj.rotation),void this.object3d.scale.copy(this.originalObj.scale);if(this.config.position){var o=this.gamepad.buttons[10].pressed;this.prevAltButtonL&&!o&&(this.isAltModeL=!this.isAltModeL),this.prevAltButtonL=o;var n=gamepad.axes[0],i=gamepad.axes[1],r=Math.abs(n)>Pt||Math.abs(i)>Pt;r&&!this.sync.isMine&&this.sync.takeOwnership();var s=200*(t/1e3);Math.abs(n)>Pt&&(this.object3d.position.x+=s*n),Math.abs(i)>Pt&&(this.isAltModeL?this.object3d.position.y+=s*-i:this.object3d.position.z+=s*i)}if(this.config.rotation){var a=this.gamepad.buttons[11].pressed;this.prevAltButtonR&&!a&&(this.isAltModeR=!this.isAltModeR),prevAltButtonR=a;var c=gamepad.axes[2],l=gamepad.axes[3],p=Math.abs(c)>Pt||Math.abs(l)>Pt;p&&!this.sync.isMine&&this.sync.takeOwnership();var h=Math.PI*(t/1e3);!this.isAltModeR&&Math.abs(l)>Pt&&(this.object3d.rotation.x+=h*l),Math.abs(c)>Pt&&(this.isAltModeR?this.object3d.rotation.z+=h*-c:this.object3d.rotation.y+=h*c)}if(this.config.scale){var d=10*(t/1e3),u=this.gamepad.buttons[12].pressed,f=this.gamepad.buttons[13].pressed,y=this.gamepad.buttons[12].pressed||this.gamepad.buttons[13].pressed;y&&!this.sync.isMine&&this.sync.takeOwnership();var v=this.object3d.scale,g=new THREE.Vector3(1,1,1);g.multiplyScalar(d),u&&this.object3d.scale.add(g),f&&v.x>g.x&&v.y>g.y&&v.z>g.z&&this.object3d.scale.sub(g)}}},Object.defineProperties(e.prototype,o),e}(Dt),Nt=function(t){function e(t){var e=this;if(this.config=Object.assign({event:"cursorenter",color:new THREE.Color("yellow")},t),"cursorenter"!==t.event&&"cursordown"!==t.event)throw Error('Expected config.event "cursorenter" or "cursordown"');this.object3d=null,this.cursordownObject=null,this.cursorenterObject=null,this.scene=null,this.cursordown=function(t){e.cursordownObject=e.object3d,"cursordown"===e.config.event&&e.setColor(cursordownObject)}.bind(this),this.cursorenter=function(t){e.cursordownObject&&e.cursordownObject!==e.object3d||(e.cursorenterObject&&e.unsetColor(e.cursorenterObject),e.cursorenterObject=e.object3d,e.setColor(e.object3d))}.bind(this),this.cursorleave=function(t){e.cursorenterObject===e.object3d&&(e.cursorenterObject=null,e.unsetColor(e.object3d))}.bind(this),this.cursorupScene=function(t){"cursordown"===e.config.event&&e.cursordownObject&&e.unsetColor(e.cursordownObject),e.cursordownObject=null}.bind(this)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"HoverColor"},e.prototype.awake=function(t,e){this.object3d=t,this.scene=e,this.object3d.addEventListener("cursordown",this.cursordown),this.scene.addEventListener("cursorup",this.cursorupScene),"cursorenter"===this.config.event&&(this.object3d.addEventListener("cursorenter",this.cursorenter),this.object3d.addEventListener("cursorleave",this.cursorleave))},e.prototype.dispose=function(){this.object3d.removeEventListener("cursordown",this.cursordown),this.scene.removeEventListener("cursorup",this.cursorupScene),this.object3d.removeEventListener("cursorenter",this.cursorenter),this.object3d.removeEventListener("cursorleave",this.cursorleave)},e.prototype.setColor=function(t){t.material&&t.material.color&&(t.userData.origColor=t.material.color,t.material.color=this.config.color,t.material&&(t.material.needsUpdate=!0)),t.children.forEach(this.setColor.bind(this))},e.prototype.unsetColor=function(t){if(t.material&&t.material.color){if(!t.userData.origColor)return void console.error("Cannot unsetColor, no userData.origColor for object",t);t.material.color=t.userData.origColor,t.material&&(t.material.needsUpdate=!0)}t.children.forEach(this.unsetColor.bind(this))},Object.defineProperties(e.prototype,o),e}(Dt),zt=function(t){function e(t){var e=this;this.config=Object.assign({scale:1.15,duration:75,revertOnDispose:!0},t),this.object3d=null,this.originalScale=null,this.elapsedTime=null,this.progress=null,this.srcScale=null,this.destScale=null,this.onHoverStateChange=function(){var t;t=[e.destScale,e.srcScale],e.srcScale=t[0],e.destScale=t[1],e.progress=1-e.progress,e.elapsedTime=e.duration-e.elapsedTime}.bind(this)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"HoverScale"},e.prototype.awake=function(t,e){this.object3d=t,this.originalScale=this.object3d.scale.clone(),this.srcScale=this.object3d.scale.clone(),this.srcScale.multiplyScalar(this.config.scale),this.destScale=new THREE.Vector3,this.destScale.copy(this.originalScale),this.progress=1,this.elapsedTime=this.config.duration,this.object3d.addEventListener("cursorenter",this.onHoverStateChange),this.object3d.addEventListener("cursorleave",this.onHoverStateChange)},e.prototype.update=function(t){this.progress<1&&(this.elapsedTime=THREE.Math.clamp(this.elapsedTime+t,0,this.config.duration),this.progress=THREE.Math.clamp(this.elapsedTime/this.config.duration,0,1),this.object3d.scale.lerpVectors(this.srcScale,this.destScale,this.progress))},e.prototype.dispose=function(){this.object3d.removeEventListener("cursorenter",this.onHoverStateChange),this.object3d.removeEventListener("cursorleave",this.onHoverStateChange),this.config.revertOnDispose&&this.object3d.scale.copy(this.originalScale),this.originalScale=null,this.srcScale=null,this.destScale=null,this.object3d=null},Object.defineProperties(e.prototype,o),e}(Dt),Ut=function(t){function e(t){this.config=Object.assign({jointCubeSize:15,joints:e.HAND_JOINTS},t),this.object3d=null,this.skeleton=null,this.jointCube=null,this.hasCollided=!1,this.collidedJoints=[],this.jointIntersectUnion=null}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"JointCollisionEvents"},e.prototype.awake=function(t,e){this.object3d=t;var o=this;x(e).then(function(t){o.skeleton=t,o.jointCube=new THREE.Vector3(o.config.jointCubeSize,o.config.jointCubeSize,o.config.jointCubeSize)}).catch(function(t){console.log("Failed to get tracking skeleton",t)})},e.prototype.update=function(t){var e=this;if(this.skeleton){for(var o=[],n=0;n<this.config.joints.length;n++)o[n]=e.skeleton.getJoint(e.config.joints[n][0],e.config.joints[n][1],e.config.joints[n][2]||0);var i=(new THREE.Box3).setFromObject(this.object3d);this.jointIntersectUnion;this.jointIntersectUnion=null;this.collidedJoints;this.collidedJoints=[];var r=this.hasCollided;if(this.hasCollided=!1,this.object3d.visible&&this.object3d.scale.x>Number.EPSILON&&this.object3d.scale.y>Number.EPSILON&&this.object3d.scale.z>Number.EPSILON)for(var s=0;s<this.config.joints.length;s++){var a=o[s];if(a&&0!==a.confidence){var c=(new THREE.Box3).setFromCenterAndSize(a.position,e.jointCube),l=i.intersectsBox(c);if(l){var p=i.intersect(c);e.jointIntersectUnion?e.jointIntersectUnion.union(p):e.jointIntersectUnion=p,e.hasCollided=!0,e.collidedJoints.push(a)}}}!r&&this.hasCollided?this.object3d.dispatchEvent(new qt(this.jointIntersectUnion,this.collidedJoints,this.object3d)):r&&!this.hasCollided&&this.object3d.dispatchEvent(new Ft(this.prevJointIntersectUnion||new THREE.Box3,this.prevCollidedJoints,this.object3d)),this.hasCollided&&object3d.dispatchEvent(new CollsionEvent(this.jointIntersectUnion,this.collidedJoints,this.object3d))}},Object.defineProperties(e.prototype,o),e}(Dt),Vt=function(t,e,o,n){this.type=t,this.detail={intersect:e,joints:o},this.bubbles=!0,this.target=n},qt=function(t){function e(){for(var e=[],o=arguments.length;o--;)e[o]=arguments[o];t.apply(this,["jointcollisionenter"].concat(e))}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e}(Vt),Ft=function(t){function e(){for(var e=[],o=arguments.length;o--;)e[o]=arguments[o];t.apply(this,["jointcollisionleave"].concat(e))}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e}(Vt);Ut.HAND_JOINTS=[["Hand","Left",0],["Thumb","Left",3],["Index","Left",3],["Middle","Left",3],["Ring","Left",3],["Pinky","Left",3],["Hand","Right",0],["Thumb","Right",3],["Index","Right",3],["Middle","Right",3],["Ring","Right",3],["Pinky","Right",3]];var Gt=Symbol("containerMax"),Wt=Symbol("containerMin"),Jt=Symbol("object3D"),Xt=Symbol("boundingBox"),Yt=Symbol("origMatrix"),Qt=Symbol("origMatrixAutoUpdate"),Zt=Symbol("parent"),Kt=Symbol("enclosure"),$t=new Map,te=function(t){function e(t){var e=t.my;void 0===e&&(e={});var o=t.at;this.my=e,this.at=o}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"Layout"},e.prototype.getAxisSettings=function(t,e,o,n){e=e||"center",e=/(\w+)([-+].+)?/.exec(e);var i=e[1],r=e[2],s=parseFloat(r)||0;return r&&r.endsWith("%")?s=s/100*(n[t]-o[t]):r&&r.endsWith("m")&&(s*=this[Kt].pixelsPerMeter),{position:i,offset:s}},e.prototype.getAnchorOffset=function(t,e){var o=this[Xt].max,n=this[Xt].min,i=this.getAxisSettings(t,e,n,o),r=i.position,s=i.offset;if("max"===r)return-o[t]+s;if("min"===r)return-n[t]+s;if("center"===r)return s;throw new Error(e+" is an invalid layout position for "+t)},e.prototype.doLayout=function(){var t=this;Array.from("xyz").forEach(function(e){var o=t.getAxisSettings(e,t.at[e],t[Wt],t[Gt]),n=o.position,i=o.offset,r=t.getAnchorOffset(e,t.my[e]);if("max"===n)t[Jt].position[e]=t[Gt][e]+i+r;else if("min"===n)t[Jt].position[e]=t[Wt][e]+i+r;else{if("center"!==n)throw new Error(t.at[e]+" is an invalid layout position for "+e);t[Jt].position[e]=i+r}}),this[Zt]&&(this[Zt].matrix=this[Yt],this[Zt].updateMatrixWorld(!0),this[Zt].matrixAutoUpdate=this[Qt])},e.prototype.awake=function(t){var e=this;this[Jt]=t,this[Xt]=(new THREE.Box3).setFromObject(this[Jt]),altspace.getEnclosure().then(function(t){if(e[Kt]=t,e[Jt].parent instanceof THREE.Scene){var o=e[Kt].innerWidth/2,n=e[Kt].innerHeight/2,i=e[Kt].innerDepth/2;e[Gt]=new THREE.Vector3(o,n,i),e[Wt]=new THREE.Vector3(-o,-n,-i),e.doLayout()}else{var r=e[Jt].getWorldScale();e[Xt].min.divide(r),e[Xt].max.divide(r),e[Zt]=e[Jt].parent,e[Yt]=e[Zt].matrix.clone(),e[Qt]=e[Zt].matrixAutoUpdate,e[Zt].matrixAutoUpdate=!1,e[Zt].matrix.identity();var s;$t.has(e[Zt].uuid)?s=$t.get(e[Zt].uuid):(e[Zt].remove(e[Jt]),s=(new THREE.Box3).setFromObject(e[Zt]),e[Zt].add(e[Jt]),$t.set(e[Zt].uuid,s)),e[Gt]=s.max,e[Wt]=s.min,e.doLayout()}})},Object.defineProperties(e.prototype,o),e}(Dt),ee=function(t){function e(t){this.config=Object.assign({position:!1,rotation:!1,scale:!1,auto:!1,world:!1},t),this.object3d=null,this.scene=null,this.ref=null,this.key=null,this.dataRef=null,this.ownerRef=null,this.transformRef=null,this.sceneSync=null,this.isMine=!1,this.position=new THREE.Vector3,this.quaternion=new THREE.Quaternion,this.scale=new THREE.Vector3}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"Object3DSync"},e.prototype.awake=function(t,e){this.object3d=t,this.scene=e,this.setupReceive()},e.prototype.setupReceive=function(){var t=this;this.transformRef.on("value",function(e){var o=e.val();!t.isMine&&o&&(t.config.position&&t.object3d.position.set(o.position.x,o.position.y,o.position.z),t.config.rotation&&t.object3d.quaternion.set(o.quaternion.x,o.quaternion.y,o.quaternion.z,o.quaternion.w),t.config.scale&&t.object3d.scale.set(o.scale.x,o.scale.y,o.scale.z))}.bind(this)),this.ownerRef.on("value",function(e){var o=e.val();o!==t.sceneSync.clientId||t.isMine||t.object3d.dispatchEvent({type:"ownershipgained"}),o!==t.sceneSync.clientId&&t.isMine&&t.object3d.dispatchEvent({type:"ownershiplost"}),t.isMine=o===t.sceneSync.clientId}.bind(this))},e.prototype.link=function(t,e){this.ref=t,this.key=this.ref.key(),this.transformRef=this.ref.child("batch"),this.dataRef=this.ref.child("data"),this.ownerRef=this.ref.child("owner"),this.sceneSync=e},e.prototype.autoSend=function(){if(this.isMine){var t={};if(this.config.world?(this.object3d.updateMatrixWorld(),this.object3d.matrixWorld.decompose(this.position,this.quaternion,this.scale)):(this.position=this.object3d.position,this.quaternion=this.object3d.quaternion,this.scale=this.object3d.scale),this.config.position&&(t.position={x:this.position.x,y:this.position.y,z:this.position.z}),this.config.rotation&&(t.quaternion={x:this.quaternion.x,y:this.quaternion.y,z:this.quaternion.z,w:this.quaternion.w}),this.config.scale&&(t.scale={x:this.scale.x,y:this.scale.y,z:this.scale.z}),Object.keys(t).length>0){if(D(t,this.lastTransform))return;this.transformRef.set(t),this.lastTransform=t}}},e.prototype.takeOwnership=function(){this.ownerRef.set(this.sceneSync.clientId)},Object.defineProperties(e.prototype,o),e}(Dt),oe=[],ne={},ie={},re=function(t){function e(t,e){this.config=Object.assign({instantiators:{},destroyers:{},ready:null,autoSendRateMS:100},e),this.instanceRef=t,this.sceneRef=t.child("scene"),this.clientsRef=t.child("clients"),this.clientId=null,this.masterClientId=null}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{},isMasterClient:{}};return o.type.get=function(){return"SceneSync"},e.prototype.awake=function(t,e){var o=this;setInterval(M,this.config.autoSendRateMS);var n=e;this.clientId=n.uuid,this.clientsRef.on("value",function(t){var e=t.val();if(e){var n=Object.keys(e)[0];o.masterClientId=e[n]}}.bind(this)),this.clientsRef.push(clientId).onDisconnect().remove(),this.instanceRef.child("initialized").once("value",function(t){var e=!t.val();t.ref().set(!0),o.config.ready&&o.config.ready(e)}.bind(this)),this.sceneRef.on("child_added",this.onInstantiate.bind(this)),this.sceneRef.on("child_removed",this.onDestroy.bind(this))},e.prototype.instantiate=function(t,e,o){void 0===e&&(e={});var n=this.sceneRef.push({syncType:t,initData:e},function(t){if(t)throw Error("Failed to save to Firebase",t)});o&&n.onDisconnect().remove();var i=ne[n.key()];return i.getBehaviorByType("Object3DSync").takeOwnership(),i},e.prototype.onInstantiate=function(t){var e=t.val(),o=t.key(),n=this.instantiators[e.syncType];if(!n)return void console.warn("No instantiator found for syncType: "+e.syncType);var i=n(e.initData,e.syncType);if(!i)return void console.error(e.syncType+".create must return an Object3D");ne[o]=i,ie[i.uuid]=o;var r=i.getBehaviorByType("Object3DSync");return r?(oe.push(r),void r.link(t.ref(),this)):void console.error(e.syncType+" instantiator must return an Object3D with an Object3DSync behavior")},e.prototype.destroy=function(t){var e=ie[t.uuid];return e?(this.sceneRef.child(e).remove(function(t){t&&console.warn("Failed to remove from Firebase",t)}),void this.sceneRef.child(e).off()):void console.warn("Failed to find key for object3d to be destroyed",t)},e.prototype.onDestroy=function(t){function e(t){t.removeAllBehaviors(),t.parent&&t.parent.remove(t),t.geometry&&t.geometry.dispose(),t.material&&(t.material.map&&t.material.map.dispose(),t.material.dispose())}var o=t.val(),n=t.key(),i=ne[n];if(!i)return void console.warn("Failed to find object matching deleted key",n);var r=o.syncType;if(!r)return void console.warn("No syncType found for object being destroyed",i);var s=this.config.destroyers[r],a=!s;s&&(a=s(i)),a&&e(i),delete ne[n],delete ie[i.uuid]},o.isMasterClient.get=function(){return this.masterClientId===this.clientId},Object.defineProperties(e.prototype,o),e}(Dt),se=function(t){function e(t){this.config=Object.assign({speed:1e-4,axis:new THREE.Vector3(0,1,0)},t),this.config.axis.normalize(),this.object3d=null}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"Spin"},e.prototype.awake=function(t){this.object3d=t},e.prototype.update=function(t){this.object3d.rotateOnAxis(this.config.axis,this.config.speed*t)},Object.defineProperties(e.prototype,o),e}(Dt),ae=function(t){function e(t){this.config=Object.assign({logging:!1},t)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"SteamVRInput"},e.prototype.awake=function(){var t=this;this.leftControllerPromise=A(e.LEFT_CONTROLLER,this.config),this.rightControllerPromise=A(e.RIGHT_CONTROLLER,this.config),this.firstControllerPromise=Promise.race([this.leftControllerPromise,this.rightControllerPromise]),this.leftControllerPromise.then(function(e){t.leftController=e}),this.rightControllerPromise.then(function(e){t.rightController=e}),this.firstControllerPromise.then(function(o){t.firstController=o;var n=o.axes.map(function(){return!1}),i=o.buttons.map(function(){return!1});i[e.BUTTON_TRIGGER]=!0,i[e.BUTTON_TOUCHPAD]=!0,o.preventDefault(n,i)})},Object.defineProperties(e.prototype,o),e}(Dt);ae.BUTTON_TRIGGER=0,ae.BUTTON_GRIP=1,ae.BUTTON_TOUCHPAD=2,ae.BUTTON_DPAD_UP=3,ae.BUTTON_DPAD_RIGHT=4,ae.BUTTON_DPAD_DOWN=5,ae.BUTTON_DPAD_LEFT=6,ae.AXIS_TOUCHPAD_X=0,ae.AXIS_TOUCHPAD_Y=1,ae.FIRST_CONTROLLER="first",ae.LEFT_CONTROLLER="left",ae.RIGHT_CONTROLLER="right";var ce=function(t){function e(t){var e=t.hand;void 0===e&&(e="first"),this._hand=e}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"SteamVRTrackedObject"},e.prototype.awake=function(t,e){this._object3d=t,this._scene=e,this._steamVRInput=this._scene.getBehaviorByType("SteamVRInput")},e.prototype.update=function(){var t=this._steamVRInput[this._hand+"Controller"],e=this._object3d;if(t){var o=t.position,n=o.x,i=o.y,r=o.z;e.position.set(n,i,r);var s=t.rotation,n=s.x,i=s.y,r=s.z,a=s.w;e.quaternion.set(n,i,r,a)}},Object.defineProperties(e.prototype,o),e}(Dt),le=function(t){function e(t){void 0===t&&(t={}),this.object3d=null,this.scene=null,this.startingRotation=null,this.activelyRotating=!1,this.lastDisplacementX=0,this.runningCount=5,this.runningAverageVelocityX=0}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var o={type:{}};return o.type.get=function(){return"TouchpadRotate"},e.prototype.awake=function(t,e){this.object3d=t,this.scene=e,altspace.addEventListener("touchpadup",this.onTouchpadUp.bind(this)),altspace.addEventListener("touchpaddown",this.onTouchpadDown.bind(this)),altspace.addEventListener("touchpadmove",this.onTouchpadMove.bind(this))},e.prototype.update=function(t){!this.activelyRotating&&Math.abs(this.runningAverageVelocityX)>.01&&(this.object3d.rotation.y+=this.runningAverageVelocityX,this.runningAverageVelocityX*=.97)},e.prototype.onTouchpadUp=function(t){this.activelyRotating=!1},e.prototype.onTouchpadDown=function(t){this.activelyRotating=!0,this.startingRotation=this.object3d.rotation.clone()},e.prototype.onTouchpadMove=function(t){var e=t.displacementX-this.lastDisplacementX;this.object3d.rotation.set(this.startingRotation.x,this.startingRotation.y+t.displacementX/300,this.startingRotation.z),this.runningAverageVelocityX=(this.runningAverageVelocityX*this.runningCount+e/300)/(this.runningCount+1),this.lastDisplacementX=t.displacementX},Object.defineProperties(e.prototype,o),e}(Dt),pe=Object.freeze({Behavior:Dt,Bob:At,ButtonStateStyle:Ht,Drag:kt,GamepadControls:Bt,HoverColor:Nt,HoverScale:zt,JointCollisionEvents:Ut,Layout:te,Object3DSync:ee,SceneSync:re,Spin:se,SteamVRInput:ae,SteamVRTrackedObject:ce,TouchpadRotate:le}),he=Object.freeze({sync:yt,Simulation:bt,multiloader:Ot,codePen:Lt,shims:xt,behaviors:pe}),de="2.0.0";window.altspace&&window.altspace.requestVersion&&window.altspace.requestVersion(de),window.AFRAME&&!window.THREE&&(window.THREE=window.AFRAME.THREE),t.components=dt,t.utilities=he,t.version=de}(this.altspace=this.altspace||{},Firebase,Url,Please);
