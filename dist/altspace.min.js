...
!function(e,t,n){"use strict";function o(e){var t={};return t=e.__proto__?Object.assign(o(e.__proto__),e):Object.assign({schema:{},dependencies:[]},e),e.schema&&Object.assign(t.schema,e.schema),e.dependencies&&(n=t.dependencies).push.apply(n,e.dependencies),t;var n}function i(e,t){AFRAME.registerComponent(e,o(new t(!0)))}function s(e,t){AFRAME.registerSystem(e,o(new t(!0)))}function a(e,t,n){return 0===t.length?n:(e[t[0]]=a(e[t[0]]||{},t.slice(1),n),e)}function r(e){return e?encodeURIComponent(e).replace(/\./g,"%2E").replace(/%[A-Z0-9]{2}/g,"-"):null}function c(){var e=document.querySelector("link[rel=canonical]");return e?e.href:window.location.href}function l(e,t,n){return r(t||n)+":"+r(e||"")}function d(e){function t(){var t={},n=l(e.appId,e.authorId,G);t.app=s.child(n).child("app"),t.space=c?t.app.child("spaces").child(c):null,t.user=d?t.app.child("users").child(d):null;var o=t.app.child("instances");return a?t.instance=o.child(a):(t.instance=o.push(),a=t.instance.key()),t}function n(){o.query["altspace-sync-instance"]||(o.query["altspace-sync-instance"]=a,window.location.href=o.toString())}e=e||{};var o=new Url,i=e.baseRefUrl||"https://altspace-apps.firebaseio.com/apps/examples/",s=new Firebase(i),a=e.instanceId||o.query["altspace-sync-instance"],c=e.spaceId||o.query["altspace-sync-space"],d=e.userId||o.query["altspace-sync-user"];if(!e.appId||!e.authorId)throw new Error("Both the appId and authorId must be provided to connect.");var p=[];return V&&(c||p.unshift(altspace.getSpace()),d||p.unshift(altspace.getUser())),Promise.all(p).then(function(e){V&&(c||(c=e.pop().sid),d||(d=e.pop().userId)),c=r(c),d=r(d),a=r(a);var o=t();return n(),o})}function u(e,t,n){if(!e||!e instanceof THREE.Scene)throw new TypeError("Requires THREE.Scene argument");if(!t||!t instanceof THREE.Camera)throw new TypeError("Requires THREE.Camera argument");B=e,U=t,p=n||{},q=p.renderer&&p.renderer.domElement||window,q.addEventListener("mousedown",h,!1),q.addEventListener("mouseup",f,!1),q.addEventListener("mousemove",v,!1)}function h(e){var t=g(e);if(t&&t.point){var n=y("cursordown",t);t.object.dispatchEvent(n)}}function f(e){var t=g(e),n=y("cursorup",t);t?t.object.dispatchEvent(n):B.dispatchEvent(n)}function v(e){var t=g(e),n=y("cursormove",t);B.dispatchEvent(n);var o=t?t.object:null;F!=o&&(F&&(n=y("cursorleave",t),F.dispatchEvent(n)),o&&(n=y("cursorenter",t),o.dispatchEvent(n)),F=o)}function y(e,t){return{type:e,bubbles:!0,target:t?t.object:null,ray:{origin:W.ray.origin.clone(),direction:W.ray.direction.clone()},point:t?t.point.clone():null}}function g(e){var t=new THREE.Vector2;t.x=e.offsetX/(q.width||q.innerWidth)*2-1,t.y=2*-(e.offsetY/(q.height||q.innerHeight))+1,W.setFromCamera(t,U);var n=W.intersectObjects(B.children,!0);return n.find(function(e){return!e.object.userData||!e.object.userData.altspace||!e.object.userData.altspace.collider||e.object.userData.altspace.collider.enabled!==!1})||null}function m(){var e,t=[],n=[],o=[],i=0;return{objUrls:t,mtlUrls:n,objects:o,error:e,objectsLoaded:i}}function b(e){var t=e||{};K=t.TRACE||!1,t.crossOrigin&&($=t.crossOrigin),t.baseUrl&&(Q=t.baseUrl),"/"!==Q.slice(-1)&&(Q+="/"),Z=new altspace.utilities.shims.OBJMTLLoader,Z.crossOrigin=$,K&&console.log("MultiLoader initialized with params",e)}function E(e,t){var n=e,o=Date.now();if(!n||!n instanceof m)throw new Error("MultiLoader.load expects first arg of type LoadRequest");if(!t||"function"!=typeof t)throw new Error("MultiLoader.load expects second arg of type function");if(!n.objUrls||!n.mtlUrls||n.objUrls.length!==n.mtlUrls.length)throw new Error("MultiLoader.load called with bad LoadRequest");var i=n.objUrls.length;K&&console.log("Loading models...");for(var s=0;s<i;s++){var a=function(e,n){var s=Q+e.objUrls[n],a=Q+e.mtlUrls[n];K&&console.log("Loading obj:"+s+", mtl:"+a),Z.load(s,a,function(s){if(e.objects[n]=s,e.objectsLoaded++,e.objectsLoaded===i){var a=((Date.now()-o)/1e3).toFixed(2);K&&console.log("Loaded "+i+" models in "+a+" seconds"),t()}},w,function(){var t=xhr.target.responseURL||"";e.error="Error loading file "+t})};a(n,s)}}function w(e){if(e.lengthComputable&&e.target.responseURL){var t=e.loaded/e.total*100,n=e.target.responseURL.split("/").pop();K&&console.log("..."+n+" "+Math.round(t,2)+"% downloaded")}}function _(){console.log("In a tile: "+ne),console.log("In VR: "+oe)}function R(){if(!ne&&oe);else{var e=document.createElement("style");e.type="text/css",e.innerHTML="@import url(https://fonts.googleapis.com/css?family=Open+Sans:800);.altspace-info{text-align:center;font-family:'Open Sans',sans-serif;line-height:.5}.altspace-vr-notice{color:rgba(0,0,0,.7);font-size:5vw}.altspace-pen-name{font-size:7vw}",document.head.appendChild(e),document.body.style.background=t.make_color({seed:O()});var n=document.createElement("div");n.className="altspace-info",document.body.appendChild(n);var o=document.createElement("span");if(o.className="altspace-pen-name",o.innerHTML="<p>"+te.toUpperCase()+"</p>",n.appendChild(o),ne){var i="VR mode does not support preview tiles. Stopping code execution.";throw console.log("ERROR: "+i),new Error(i)}if(!oe){var s=document.createElement("span");s.className="altspace-vr-notice",s.innerHTML="<p>View</p>",n.insertBefore(s,o);var a=document.createElement("span");a.className="altspace-vr-notice",a.innerHTML='<p>in <a href="http://altvr.com"> AltspaceVR </a></p>',n.appendChild(a);var i="Not in VR mode. Stopping code execution.";throw ne&&console.log("ERROR: "+i),new Error(i)}}}function L(e){te=e}function j(){var e=document.querySelector("link[rel=canonical]"),t=e?e.href:window.location.href;return new n(t)}function O(){var e=j(),t=e.path.split("/"),n=t[t.length-1];return n}function S(){var e=j(),t=e.path.split("/"),n="team"==t[1],o=n?"team-"+t[2]:t[1];return o}function C(e){var t,n,o=this;if(e.bubbles&&(e.currentTarget=this,e.stopPropagation=function(){t=!0},e.stopImmediatePropagation=function(){n=!0}),this._listeners){var i=this._listeners,s=i[e.type];if(s){e.target=e.target||this;for(var a=[],r=s.length,c=0;c<r;c++)a[c]=s[c];for(var c=0;c<r;c++)if(a[c].call(o,e),n)return}}e.bubbles&&this.parent&&this.parent.dispatchEvent&&!t&&C.call(this.parent,e)}t="default"in t?t.default:t,n="default"in n?n.default:n;var T=function(){},M={schema:{}};M.schema.get=function(){return null},T.prototype.init=function(){},T.prototype.tick=function(e,t){},T.prototype.pause=function(){},T.prototype.play=function(){},Object.defineProperties(T.prototype,M);var I=function(e){function t(){e.apply(this,arguments)}return e&&(t.__proto__=e),t.prototype=Object.create(e&&e.prototype),t.prototype.constructor=t,t.prototype.update=function(e){},t.prototype.remove=function(){},t.prototype.updateSchema=function(e){},t}(T),A=function(e){function t(){e.apply(this,arguments)}e&&(t.__proto__=e),t.prototype=Object.create(e&&e.prototype),t.prototype.constructor=t;var n={schema:{}};return n.schema.get=function(){return{enabled:{type:"boolean",default:"true"}}},t.prototype.init=function(){var e=this;this.setColliderFlag(this.data.enabled),this.el.addEventListener("model-loaded",function(){e.setColliderFlag(e.data.enabled)}.bind(this))},t.prototype.update=function(){this.setColliderFlag(this.data.enabled)},t.prototype.setColliderFlag=function(e){var t=this.el.object3D;t&&(console.log("Setting collider flag to",e),a(t.userData,["altspace","collider","enabled"],e),t.traverse(function(t){t instanceof THREE.Mesh&&a(t.userData,["altspace","collider","enabled"],e)}))},Object.defineProperties(t.prototype,n),t}(I),D=function(e){function t(){e.apply(this,arguments)}return e&&(t.__proto__=e),t.prototype=Object.create(e&&e.prototype),t.prototype.constructor=t,t.prototype.init=function(){this.gamepadIndex=null,this.trackedControlsSystem=document.querySelector("a-scene").systems["tracked-controls"],this.systemGamepads=0,altspace.getGamepads()},t.prototype.tick=function(){if(this.trackedControlsSystem&&this.systemGamepads!==this.trackedControlsSystem.controllers.length&&window.altspace&&altspace.getGamepads&&altspace.getGamepads().length){var e=this.el.components;e["paint-controls"]&&(this.gamepadIndex="left"===e["paint-controls"].data.hand?2:1),null===this.gamepadIndex&&e["hand-controls"]&&(this.gamepadIndex="left"===e["hand-controls"].data?2:1),null===this.gamepadIndex&&e["vive-controls"]&&(this.gamepadIndex="left"===e["vive-controls"].data.hand?2:1),null===this.gamepadIndex&&e["tracked-controls"]&&(this.gamepadIndex=e["tracked-controls"].data.controller),this.el.setAttribute("tracked-controls","id",altspace.getGamepads()[this.gamepadIndex].id),this.el.setAttribute("tracked-controls","controller",0),this.systemGamepads=this.trackedControlsSystem.controllers.length}},t}(I),k=function(e){function t(){e.apply(this,arguments)}e&&(t.__proto__=e),t.prototype=Object.create(e&&e.prototype),t.prototype.constructor=t;var n={schema:{}};return n.schema.get=function(){return{usePixelScale:{type:"boolean",default:"false"},verticalAlign:{type:"string",default:"middle"},enclosuresOnly:{type:"boolean",default:"true"},fullspace:{type:"boolean",default:"false"}}},t.prototype.init=function(){return this.version="AFRAME_ALTSPACE_VERSION",!this.el.object3D instanceof THREE.Scene?void console.warn("aframe-altspace-component can only be attached to a-scene"):void(window.altspace&&window.altspace.inClient?(this.el.setAttribute("vr-mode-ui",{enabled:!1}),this.initRenderer(),this.initCursorEvents(),this.initCollisionEvents()):console.warn("aframe-altspace-component only works inside of AltspaceVR"))},t.prototype.tick=function(e,t){this.el.object3D.updateAllBehaviors&&this.el.object3D.updateAllBehaviors()},t.prototype.initRenderer=function(){var e=this,t=this.el.object3D;altspace.getEnclosure().then(function(o){switch(e.data.fullspace&&(o.requestFullspace(),o.addEventListener("fullspacechange",function(){t.scale.setScalar(o.pixelsPerMeter)})),e.data.usePixelScale&&!e.data.fullspace||t.scale.setScalar(o.pixelsPerMeter),e.data.verticalAlign){case"bottom":t.position.y-=o.innerHeight/2;break;case"top":t.position.y+=o.innerHeight/2;break;case"middle":break;default:console.warn("Unexpected value for verticalAlign: ",e.data.verticalAlign)}e.data.enclosuresOnly&&1===o.innerDepth&&(e.el.renderer.render(new THREE.Scene),e.el.renderer=e.el.effect=n)}.bind(this));var n=this.el.renderer,o=this.el.renderer=this.el.effect=altspace.getThreeJSRenderer({aframeComponentVersion:this.version}),i=function(){};o.setSize=i,o.setPixelRatio=i,o.setClearColor=i,o.clear=i,o.enableScissorTest=i,o.setScissor=i,o.setViewport=i,o.getPixelRatio=i,o.getMaxAnisotropy=i,o.setFaceCulling=i,o.context={canvas:{}},o.shadowMap={}},t.prototype.initCursorEvents=function(){function e(e,t){var o=t.target.el;n&&n.emit(e,{target:o,ray:t.ray,point:t.point}),o&&o.emit(e,{target:o,ray:t.ray,point:t.point})}var t=this.el.object3D,n=document.querySelector("a-cursor")||document.querySelector("a-entity[cursor]");n&&(n.setAttribute("material","transparent",!0),n.setAttribute("material","opacity",0));var o=null;t.addEventListener("cursordown",function(t){o=t.target,e("mousedown",t)}),t.addEventListener("cursorup",function(t){e("mouseup",t),t.target.uuid===o.uuid&&e("click",t),o=null}),t.addEventListener("cursorenter",function(t){t.target.el&&(t.target.el.addState("hovered"),n&&n.addState("hovering"),e("mouseenter",t))}),t.addEventListener("cursorleave",function(t){t.target.el&&(t.target.el.removeState("hovered"),n&&n.removeState("hovering"),e("mouseleave",t))})},t.prototype.initCollisionEvents=function(){function e(e,t){var n=t.target.el;n&&(t.target=n,t.other&&t.other.el&&(t.other=t.other.el),n.emit(e,t))}var t=this.el.object3D;t.addEventListener("collisionenter",function(t){e("collisionenter",t)}),t.addEventListener("collisionexit",function(t){e("collisionexit",t)}),t.addEventListener("triggerenter",function(t){e("triggerenter",t)}),t.addEventListener("triggerexit",function(t){e("triggerexit",t)})},Object.defineProperties(t.prototype,n),t}(I),H=function(e){function t(){e.apply(this,arguments)}e&&(t.__proto__=e),t.prototype=Object.create(e&&e.prototype),t.prototype.constructor=t;var n={dependencies:{}};return n.dependencies.get=function(){return["sync"]},t.prototype.init=function(){this.sync=this.el.components.sync,this.sync.isConnected?start():this.el.addEventListener("connected",this.start.bind(this))},t.prototype.start=function(){var e=this.sync.dataRef.child("material/color"),t=!1,n=!0;this.el.addEventListener("componentchanged",function(n){var o=n.detail.name,i=n.detail.oldData,s=n.detail.newData;"material"===o&&!t&&i.color!==s.color&&sync.isMine&&setTimeout(function(){return e.set(s.color)},0)});var o=this;e.on("value",function(e){if(!o.sync.isMine||n){var i=e.val();t=!0,o.el.setAttribute("material","color",i),t=!1,n=!1}})},Object.defineProperties(t.prototype,n),t}(I),x=function(e){function t(e){void 0===e&&(e=!1),this._isComponent=e,this.scene=void 0,this.syncSys=void 0,this.ref=void 0,this.key=void 0,this.dataRef=void 0,this.ownerRef=void 0,this.ownerId=void 0,this.isConnected=!1,this.isMine=!1}e&&(t.__proto__=e),t.prototype=Object.create(e&&e.prototype),t.prototype.constructor=t;var n={schema:{}};return n.schema.get=function(){return{mode:{default:"link"},ownOn:{type:"string"}}},t.prototype.init=function(){var e=this;if(this.scene=this.el.sceneEl,this.syncSys=this.scene.systems["sync-system"],this.syncSys.isConnected?start():this.scene.addEventListener("connected",this.start.bind(this)),this.data.ownOn){var t=this.data.ownOn.split(/[ ,]+/);t.forEach(function(t){e.el.addEventListener(t,function(){e.isConnected&&e.takeOwnership()}.bind(e))}.bind(this))}},t.prototype.takeOwnership=function(){this.ownerRef.set(this.syncSys.clientId),this.ownerRef.onDisconnect().set(null)},t.prototype.start=function(){var e=this;if(this.scene.addEventListener("clientleft",function(t){var n=(!ownerId||ownerId===t.detail.id)&&e.syncSys.isMasterClient;n&&e.takeOwnership()}.bind(this)),"link"!==this.data.mode)return void console.error("Unsupported sync mode: "+this.data.mode);var t=this.el.id;return t?(console.log("syncSys: "+this.syncSys),console.log("syncSys.sceneRef: "+this.syncSys.sceneRef),this.link(this.syncSys.sceneRef.child(t)),this.setupReceive(),this.isConnected=!0,void this.el.emit("connected",null,!1)):void console.error("Entities cannot be synced using link mode without an id.")},t.prototype.link=function(e){this.ref=e,this.key=this.ref.key(),this.dataRef=this.ref.child("data"),this.ownerRef=this.ref.child("owner")},t.prototype.setupReceive=function(){var e=this;this.ownerRef.transaction(function(t){if(!t)return e.ownerRef.onDisconnect().set(null),e.syncSys.clientId}.bind(this)),this.ownerRef.on("value",function(t){var n=t.val(),o=n===e.syncSys.clientId&&!e.isMine;o&&e.el.emit("ownershipgained",null,!1);var i=n!==e.syncSys.clientId&&e.isMine;i&&(e.el.emit("ownershiplost",null,!1),e.ownerRef.onDisconnect().cancel()),e.ownerId=n,e.isMine=n===e.syncSys.clientId}.bind(this))},Object.defineProperties(t.prototype,n),t}(I),P=function(e){function t(){e.apply(this,arguments)}e&&(t.__proto__=e),t.prototype=Object.create(e&&e.prototype),t.prototype.constructor=t;var n={schema:{}};return n.schema.get=function(){return{author:{type:"string",default:null},app:{type:"string",default:null},instance:{type:"string",default:null},refUrl:{type:"string",default:null}}},t.prototype.init=function(){return this.data&&this.data.app?(console.log(this.data),this.isConnected=!1,void altspace.utilities.sync.connect({authorId:this.data.author,appId:this.data.app,instanceId:this.data.instance,baseRefUrl:this.data.refUrl}).then(this.connected.bind(this))):void console.warn("The sync-system must be present on the scene and configured with required data.")},t.prototype.connected=function(e){this.connection=e,this.sceneRef=this.connection.instance.child("scene"),this.clientsRef=this.connection.instance.child("clients"),this.clientId=this.sceneEl.object3D.uuid,this.masterClientId=null;var t=this;this.clientsRef.on("value",function(e){var n=e.val(),o=Object.keys(n)[0];t.masterClientId=n[o]}),this.clientsRef.on("child_added",function(e){var n=e.val();setTimeout(function(){t.sceneEl.emit("clientjoined",{id:n},!1)},0)}),this.clientsRef.on("child_removed",function(e){var n=e.val();setTimeout(function(){t.sceneEl.emit("clientleft",{id:n},!1)},0)}),this.clientsRef.push(this.clientId).onDisconnect().remove(),this.connection.instance.child("initialized").once("value",function(e){var n=!e.val();e.ref().set(!0),t.sceneEl.emit("connected",{shouldInitialize:n},!1),t.isConnected=!0})},t.prototype.isMasterClient=function(){return this.masterClientId===this.clientId},Object.defineProperties(t.prototype,n),t}(T);AFRAME.registerComponent("sync-transform",{dependencies:["sync"],schema:{},init:function(){function e(){function e(e,o){if(!n.isMine){var i=e.val();i&&t.el.setAttribute(o,i)}}function o(e){if(n.isMine){var t=e.detail.name,o=e.detail.newData;if("position"===t)l(o);else if("rotation"===t)d(o);else{if("scale"!==t)return;p(o)}}}function i(e,t,n){var o,i,s,a,r=0;n||(n={});var c=function(){r=n.leading===!1?0:Date.now(),o=null,a=e.apply(i,s),o||(i=s=null)},l=function(){var l=Date.now();r||n.leading!==!1||(r=l);var d=t-(l-r);return i=this,s=arguments,d<=0||d>t?(o&&(clearTimeout(o),o=null),r=l,a=e.apply(i,s),o||(i=s=null)):o||n.trailing===!1||(o=setTimeout(c,d)),a};return l.cancel=function(){clearTimeout(o),r=0,o=i=s=null},l}var s=n.dataRef.child("position"),a=n.dataRef.child("rotation"),r=n.dataRef.child("scale");t.updateRate=100;var c=[];t.el.addEventListener("ownershiplost",function(){for(var e=t.el.children,n=0;n<e.length;n++){var o=e[n].tagName.toLowerCase();"a-animation"===o&&(c.push(e[n]),e[n].stop())}}),t.el.addEventListener("ownershipgained",function(){for(var e=0;e<c.length;e++){var t=c[e];t.start()}c=[]}),s.on("value",function(t){e(t,"position")}),a.on("value",function(t){e(t,"rotation")}),r.on("value",function(t){e(t,"scale")});var l=i(function(e){s.set(e)},t.updateRate),d=i(function(e){a.set(e)},t.updateRate),p=i(function(e){r.set(e)},t.updateRate);t.el.addEventListener("componentchanged",o)}var t=this,n=t.el.components.sync;n.isConnected?e():t.el.addEventListener("connected",e)}});(function(e){function t(){e.apply(this,arguments)}e&&(t.__proto__=e),t.prototype=Object.create(e&&e.prototype),t.prototype.constructor=t;var n={dependencies:{}};return n.dependencies.get=function(){return["sync"]},Object.defineProperties(t.prototype,n),t})(I);AFRAME.registerComponent("sync-n-sound",{dependencies:["sync"],schema:{},init:function(){function e(){function e(e){if(n.isMine){var e={type:e.type,sender:i.clientId,el:t.el.id,time:Date.now()};t.soundEventRef.set(e)}}t.soundStateRef=n.dataRef.child("sound/state"),t.soundEventRef=n.dataRef.child("sound/event"),t.el.addEventListener("sound-played",e),t.el.addEventListener("sound-paused",e),t.soundEventRef.on("value",function(e){if(!n.isMine){var o=e.val();if(o&&o.el===t.el.id){var i=t.el.components["n-sound"];"sound-played"===o.type?i.playSound():i.pauseSound()}}}),t.el.addEventListener("componentchanged",function(e){if(n.isMine){var o=e.detail.name;"n-sound"===o&&t.soundStateRef.set(e.detail.newData)}}),t.soundStateRef.on("value",function(e){if(!n.isMine){var o=e.val();o&&t.el.setAttribute("n-sound",o)}})}var t=this,n=t.el.components.sync,o=document.querySelector("a-scene"),i=o.systems["sync-system"];n.isConnected?e():t.el.addEventListener("connected",e)},remove:function(){this.soundStateRef.off("value"),this.soundEventRef.off("value")}}),AFRAME.registerComponent("wire",{multiple:!0,schema:{on:{type:"string"},emit:{type:"string"},gained:{type:"string"},lost:{type:"string"},gain:{type:"string"},lose:{type:"string"},targets:{type:"selectorAll"},target:{type:"selector"}},update:function(e){e.on&&this.el.removeEventListener(e.on,this.actOnTargets),e.gained&&this.el.removeEventListener("stateadded",this.actOnTargetsIfStateMatches),e.lost&&this.el.removeEventListener("stateremoved",this.actOnTargetsIfStateMatches),this.actOnTargets=function(){function e(e){this.data.emit&&e.emit(this.data.emit),this.data.gain&&e.addState(this.data.gain),this.data.lose&&e.removeState(this.data.lose)}this.data.targets&&this.data.targets.forEach(e.bind(this)),this.data.target&&e.call(this,this.data.target)}.bind(this),this.actOnTargetsIfStateMatches=function(e){var t=e.detail.state;t!==this.data.gained&&t!==this.data.lost||this.actOnTargets()}.bind(this),this.data.on&&this.el.addEventListener(this.data.on,this.actOnTargets),this.data.gained&&this.el.addEventListener("stateadded",this.actOnTargetsIfStateMatches),this.data.lost&&this.el.addEventListener("stateremoved",this.actOnTargetsIfStateMatches)},remove:function(){this.el.removeEventListener(this.data.on,this.actOnTargets),this.el.removeEventListener("stateadded",this.actOnTargetsIfStateMatches),this.el.removeEventListener("stateremoved",this.actOnTargetsIfStateMatches)}}),window.AFRAME&&(s("sync-system",P),i("altspace-cursor-collider",A),i("altspace-tracked-controls",D),i("altspace",k),i("sync-color",H),i("sync",x));var B,U,q,F,z=Object.freeze({AltspaceComponent:k,AltspaceCursorCollider:A,AltspaceTrackedControls:D,SyncSystem:P,SyncComponent:x,SyncColor:H,flatten:o}),V=altspace&&altspace.inClient,G=c(),N=Object.freeze({connect:d}),W=new THREE.Raycaster,J=Object.freeze({init:u});window.altspace=window.altspace||{},window.altspace.utilities=window.altspace.utilities||{};var X=function(e){var t=e.auto;void 0===t&&(t=!0),this._scene=null,this._renderer=null,this._camera=null;var n=window.AFRAME&&document.querySelector("a-scene");if(n){var o=document.querySelector("a-scene");this._scene=o.object3D,this._renderer=o.renderer;var i=document.querySelector("a-camera");i&&(this._camera=i.object3D)}else window.altspace&&altspace.inClient?(this._scene=new THREE.Scene,this._renderer=altspace.getThreeJSRenderer(),this._camera=new THREE.PerspectiveCamera):this._setupWebGL();t&&!n&&this.loop()},Y={scene:{},renderer:{},camera:{}};X.prototype._setupWebGL=function(){function e(){o.aspect=window.innerWidth/window.innerHeight,o.updateProjectionMatrix(),n.setSize(window.innerWidth,window.innerHeight)}var t=this._scene=new THREE.Scene,n=this._renderer=new THREE.WebGLRenderer({antialias:!0}),o=this._camera=new THREE.PerspectiveCamera;document.addEventListener("DOMContentLoaded",function(e){document.body.style.margin="0px",document.body.style.overflow="hidden",n.setClearColor("#035F72");var t=document.createElement("div");document.body.appendChild(t),t.appendChild(n.domElement)}),window.addEventListener("resize",e),e(),o.position.z=500,o.fov=45,o.near=1,o.far=2e3,t.add(o),t.add(new THREE.AmbientLight("white")),this.cursor=u(t,o)},X.prototype.loop=function(){window.requestAnimationFrame(this.loop.bind(this)),this.scene.updateAllBehaviors&&this.scene.updateAllBehaviors(),this.renderer.render(this.scene,this.camera)},Y.scene.get=function(){return this._scene},Y.renderer.get=function(){return this._renderer},Y.camera.get=function(){return this._camera},Object.defineProperties(X.prototype,Y);var Z,K,Q="",$="",ee=Object.freeze({init:b,load:E,LoadRequest:m}),te="VR CodePen",ne=window.name&&"pen-"===window.name.slice(0,4),oe=!!window.altspace.inClient,ie=!!location.href.match("codepen.io/"),se=Object.freeze({inTile:ne,inVR:oe,inCodePen:ie,ensureInVR:R,setName:L,getPenId:O,getAuthorId:S,printDebugInfo:_}),ae=function(){};ae.prototype.load=function(e,t,n){var o=new THREE.MTLLoader,i=t.split("/").slice(0,-1).join("/");o.setBaseUrl(i+"/"),o.setCrossOrigin(this.crossOrigin),o.load(t,function(t){var o=new THREE.OBJLoader;o.setMaterials(t),o.load(e,n)})},THREE&&!altspace.inClient&&(THREE.EventDispatcher.prototype.dispatchEvent=C,THREE.Object3D.prototype.dispatchEvent=C),THREE.Scene.prototype.updateAllBehaviors=function(){var e=performance.now(),t=this.__lastNow||e,n=e-t,o=this,i=[];this.traverse(function(e){e.__behaviorList&&i.push(e)});for(var s=0,a=i.length;s<a;s++){var r=i[s];r.updateBehaviors(n,o)}this.__lastNow=e},THREE.Object3D.prototype.addBehavior=function(e){this.addBehaviors(e)},THREE.Object3D.prototype.addBehaviors=function(){for(var e=[],t=arguments.length;t--;)e[t]=arguments[t];this.__behaviorList=this.__behaviorList||[],(n=this.__behaviorList).push.apply(n,e);var n},THREE.Object3D.prototype.removeBehavior=function(e){if(!this.__behaviorList||0===this.__behaviorList.length)return null;var t=this.__behaviorList.indexOf(e);if(t!==-1){this.__behaviorList.splice(t,1);try{e.dispose&&e.dispose.call(e,this)}catch(t){console.group(),(console.error||console.log).call(console,t.stack||t),console.log("[Behavior]"),console.log(e),console.log("[Object3D]"),console.log(this),console.groupEnd()}}},THREE.Object3D.prototype.removeAllBehaviors=function(){var e=this;if(!this.__behaviorList||0===this.__behaviorList.length)return null;for(var t=0,n=this.__behaviorList.length;t<n;t++){var o=e.__behaviorList[t];try{o.dispose&&o.dispose.call(o,e)}catch(t){console.group(),(console.error||console.log).call(console,t.stack||t),console.log("[Behavior]"),console.log(o),console.log("[Object3D]"),console.log(e),console.groupEnd()}}this.__behaviorList.length=0},THREE.Object3D.prototype.getBehaviorByType=function(e){var t=this;if(!this.__behaviorList||0===this.__behaviorList.length)return null;for(var n=0,o=this.__behaviorList.length;n<o;n++)if(t.__behaviorList[n].type===e)return t.__behaviorList[n]},THREE.Object3D.prototype.updateBehaviors=function(e,t){var n=this;if(this.__behaviorList&&0!==this.__behaviorList.length){for(var o=[],i=this.__behaviorList.slice(),s=0,a=this.__behaviorList.length;s<a;s++){var r=n.__behaviorList[s];r.__isInitialized||o.push(r)}for(var s=0,a=o.length;s<a;s++){var r=o[s];try{r.awake&&r.awake.call(r,n,t)}catch(e){console.group(),(console.error||console.log).call(console,e.stack||e),console.log("[Behavior]"),console.log(r),console.log("[Object3D]"),console.log(n),console.groupEnd()}}for(var s=0,a=o.length;s<a;s++){var r=o[s];try{r.start&&r.start.call(r)}catch(e){console.group(),(console.error||console.log).call(console,e.stack||e),console.log("[Behavior]"),console.log(r),console.log("[Object3D]"),console.log(n),console.groupEnd()}r.__isInitialized=!0}for(var s=0,a=i.length;s<a;s++){var r=i[s];try{r.update&&r.update.call(r,e)}catch(e){console.group(),(console.error||console.log).call(console,e.stack||e),console.log("[Behavior]"),console.log(r),console.log("[Object3D]"),console.log(n),console.groupEnd()}}}};var re=Object.freeze({OBJMTLLoader:ae,cursor:J}),ce=function(){},le={type:{}};le.type.get=function(){return"Behavior"},ce.prototype.awake=function(e,t){},ce.prototype.start=function(){},ce.prototype.update=function(e){},ce.prototype.dispose=function(e){},Object.defineProperties(ce.prototype,le);var de=function(e){function t(e){this.config=Object.assign({x:3,y:5,shouldRotate:!0,shouldMove:!0},e),this.object3d=null,this.offsetPosition=null,this.lastBobPosition=new THREE.Vector3,this.nowOffset=1e4*Math.random()}return e&&(t.__proto__=e),t.prototype=Object.create(e&&e.prototype),t.prototype.constructor=t,t.prototype.awake=function(e){this.object3d=e,this.offsetPosition=object3D.position.clone()},t.prototype.update=function(e){var t=Math.floor(performance.now())+this.nowOffset;this.config.shouldMove&&(this.lastBobPosition.equals(this.object3d.position)||this.offsetPosition.copy(this.object3d.position),this.object3d.position.y+=Math.sin(t/800)*this.config.x,this.object3d.position.x+=Math.sin(t/500)*this.config.y,this.lastBobPosition.copy(this.object3d.position)),this.config.shouldRotate&&(object3d.rotation.x=Math.sin(t/500)/15)},t}(ce),pe=Object.freeze({Behavior:ce,Bob:de}),ue=Object.freeze({sync:N,Simulation:X,multiloader:ee,codePen:se,shims:re,behaviors:pe}),he="2.0.0";window.altspace&&window.altspace.requestVersion&&window.altspace.requestVersion(he),window.AFRAME&&!window.THREE&&(window.THREE=window.AFRAME.THREE),e.components=z,e.utilities=ue,e.version=he}(this.altspace=this.altspace||{},Please,Url);
