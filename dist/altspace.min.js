...
!function(t,e,n,o){"use strict";function i(t){var e={};return e=t.__proto__?Object.assign(i(t.__proto__),t):Object.assign({schema:{},dependencies:[]},t),t.schema&&Object.assign(e.schema,t.schema),t.dependencies&&(n=e.dependencies).push.apply(n,t.dependencies),e;var n}function s(t,e){AFRAME.registerComponent(t,i(new e(!0)))}function r(t,e){AFRAME.registerSystem(t,i(new e(!0)))}function a(t,e,n){return 0===e.length?n:(t[e[0]]=a(t[e[0]]||{},e.slice(1),n),t)}function c(t){return t?encodeURIComponent(t).replace(/\./g,"%2E").replace(/%[A-Z0-9]{2}/g,"-"):null}function l(){var t=document.querySelector("link[rel=canonical]");return t?t.href:window.location.href}function d(t,e,n){return c(e||n)+":"+c(t||"")}function h(t){function o(){var e={},n=d(t.appId,t.authorId,Q);e.app=a.child(n).child("app"),e.space=h?e.app.child("spaces").child(h):null,e.user=p?e.app.child("users").child(p):null;var o=e.app.child("instances");return l?e.instance=o.child(l):(e.instance=o.push(),l=e.instance.key()),e}function i(){s.query["altspace-sync-instance"]||(s.query["altspace-sync-instance"]=l,window.location.href=s.toString())}t=t||{};var s=new n,r=t.baseRefUrl||"https://altspace-apps.firebaseio.com/apps/examples/",a=new e(r),l=t.instanceId||s.query["altspace-sync-instance"],h=t.spaceId||s.query["altspace-sync-space"],p=t.userId||s.query["altspace-sync-user"];if(!t.appId||!t.authorId)throw new Error("Both the appId and authorId must be provided to connect.");var u=[];return Y&&(h||u.unshift(altspace.getSpace()),p||u.unshift(altspace.getUser())),Promise.all(u).then(function(t){Y&&(h||(h=t.pop().sid),p||(p=t.pop().userId)),h=c(h),p=c(p),l=c(l);var e=o();return i(),e})}function u(t,e,n){if(!t||!t instanceof THREE.Scene)throw new TypeError("Requires THREE.Scene argument");if(!e||!e instanceof THREE.Camera)throw new TypeError("Requires THREE.Camera argument");q=t,G=e,p=n||{},W=p.renderer&&p.renderer.domElement||window,W.addEventListener("mousedown",f,!1),W.addEventListener("mouseup",v,!1),W.addEventListener("mousemove",y,!1)}function f(t){var e=b(t);if(e&&e.point){var n=g("cursordown",e);e.object.dispatchEvent(n)}}function v(t){var e=b(t),n=g("cursorup",e);e?e.object.dispatchEvent(n):q.dispatchEvent(n)}function y(t){var e=b(t),n=g("cursormove",e);q.dispatchEvent(n);var o=e?e.object:null;J!=o&&(J&&(n=g("cursorleave",e),J.dispatchEvent(n)),o&&(n=g("cursorenter",e),o.dispatchEvent(n)),J=o)}function g(t,e){return{type:t,bubbles:!0,target:e?e.object:null,ray:{origin:K.ray.origin.clone(),direction:K.ray.direction.clone()},point:e?e.point.clone():null}}function b(t){var e=new THREE.Vector2;e.x=t.offsetX/(W.width||W.innerWidth)*2-1,e.y=2*-(t.offsetY/(W.height||W.innerHeight))+1,K.setFromCamera(e,G);var n=K.intersectObjects(q.children,!0);return n.find(function(t){return!t.object.userData||!t.object.userData.altspace||!t.object.userData.altspace.collider||t.object.userData.altspace.collider.enabled!==!1})||null}function m(){var t,e=[],n=[],o=[],i=0;return{objUrls:e,mtlUrls:n,objects:o,error:t,objectsLoaded:i}}function E(t){var e=t||{};ot=e.TRACE||!1,e.crossOrigin&&(st=e.crossOrigin),e.baseUrl&&(it=e.baseUrl),"/"!==it.slice(-1)&&(it+="/"),nt=new altspace.utilities.shims.OBJMTLLoader,nt.crossOrigin=st,ot&&console.log("MultiLoader initialized with params",t)}function j(t,e){var n=t,o=Date.now();if(!n||!n instanceof m)throw new Error("MultiLoader.load expects first arg of type LoadRequest");if(!e||"function"!=typeof e)throw new Error("MultiLoader.load expects second arg of type function");if(!n.objUrls||!n.mtlUrls||n.objUrls.length!==n.mtlUrls.length)throw new Error("MultiLoader.load called with bad LoadRequest");var i=n.objUrls.length;ot&&console.log("Loading models...");for(var s=0;s<i;s++){var r=function(t,n){var s=it+t.objUrls[n],r=it+t.mtlUrls[n];ot&&console.log("Loading obj:"+s+", mtl:"+r),nt.load(s,r,function(s){if(t.objects[n]=s,t.objectsLoaded++,t.objectsLoaded===i){var r=((Date.now()-o)/1e3).toFixed(2);ot&&console.log("Loaded "+i+" models in "+r+" seconds"),e()}},w,function(){var e=xhr.target.responseURL||"";t.error="Error loading file "+e})};r(n,s)}}function w(t){if(t.lengthComputable&&t.target.responseURL){var e=t.loaded/t.total*100,n=t.target.responseURL.split("/").pop();ot&&console.log("..."+n+" "+Math.round(e,2)+"% downloaded")}}function _(){console.log("In a tile: "+ct),console.log("In VR: "+lt)}function R(){if(!ct&&lt);else{var t=document.createElement("style");t.type="text/css",t.innerHTML="@import url(https://fonts.googleapis.com/css?family=Open+Sans:800);.altspace-info{text-align:center;font-family:'Open Sans',sans-serif;line-height:.5}.altspace-vr-notice{color:rgba(0,0,0,.7);font-size:5vw}.altspace-pen-name{font-size:7vw}",document.head.appendChild(t),document.body.style.background=o.make_color({seed:S()});var e=document.createElement("div");e.className="altspace-info",document.body.appendChild(e);var n=document.createElement("span");if(n.className="altspace-pen-name",n.innerHTML="<p>"+at.toUpperCase()+"</p>",e.appendChild(n),ct){var i="VR mode does not support preview tiles. Stopping code execution.";throw console.log("ERROR: "+i),new Error(i)}if(!lt){var s=document.createElement("span");s.className="altspace-vr-notice",s.innerHTML="<p>View</p>",e.insertBefore(s,n);var r=document.createElement("span");r.className="altspace-vr-notice",r.innerHTML='<p>in <a href="http://altvr.com"> AltspaceVR </a></p>',e.appendChild(r);var i="Not in VR mode. Stopping code execution.";throw ct&&console.log("ERROR: "+i),new Error(i)}}}function O(t){at=t}function T(){var t=document.querySelector("link[rel=canonical]"),e=t?t.href:window.location.href;return new n(e)}function S(){var t=T(),e=t.path.split("/"),n=e[e.length-1];return n}function L(){var t=T(),e=t.path.split("/"),n="team"==e[1],o=n?"team-"+e[2]:e[1];return o}function C(t){var e,n,o=this;if(t.bubbles&&(t.currentTarget=this,t.stopPropagation=function(){e=!0},t.stopImmediatePropagation=function(){n=!0}),this._listeners){var i=this._listeners,s=i[t.type];if(s){t.target=t.target||this;for(var r=[],a=s.length,c=0;c<a;c++)r[c]=s[c];for(var c=0;c<a;c++)if(r[c].call(o,t),n)return}}t.bubbles&&this.parent&&this.parent.dispatchEvent&&!e&&C.call(this.parent,t)}function I(t){t.updateMatrixWorld();var e=new THREE.Vector3;return e.setFromMatrixPosition(t.matrixWorld),e}function x(t){return new Promise(function(e,n){var o=null;return t.traverse(function(t){if("TrackingSkeleton"===t.type)return void(o=t)}),o?e(o):void altspace.getThreeJSTrackingSkeleton().then(function(n){return o=n,t.add(o),e(o)})})}function M(t,e){if(t===e)return!0;if(Array.isArray(t)&&Array.isArray(e)&&t.length===e.length)return t.every(function(n,o){return M(t[o],e[o])});if(t instanceof Object&&e instanceof Object&&M(Object.keys(t).sort(),Object.keys(e).sort())){for(var n in t)if(!M(t[n],e[n]))return!1;return!0}return!1}function D(){Bt.forEach(function(t){return t.autoSend()})}function A(t,e){var n=function(o,i){var s=altspace.getGamepads().find(function(e){return"steamvr"===e.mapping&&e.hand===t});s?(e.logging&&console.log("SteamVR input device found",s),o(s)):(e.logging&&console.log("SteamVR input device not found trying again in 500ms..."),setTimeout(n,500,o,i))};return new Promise(n)}e="default"in e?e.default:e,n="default"in n?n.default:n,o="default"in o?o.default:o;var k=function(){},H={schema:{}};H.schema.get=function(){return null},k.prototype.init=function(){},k.prototype.tick=function(t,e){},k.prototype.pause=function(){},k.prototype.play=function(){},Object.defineProperties(k.prototype,H);var P=function(t){function e(){t.apply(this,arguments)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.update=function(t){},e.prototype.remove=function(){},e.prototype.updateSchema=function(t){},e}(k),B=function(t){function e(){t.apply(this,arguments)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={schema:{}};return n.schema.get=function(){return{enabled:{type:"boolean",default:"true"}}},e.prototype.init=function(){var t=this;this.setColliderFlag(this.data.enabled),this.el.addEventListener("model-loaded",function(){t.setColliderFlag(t.data.enabled)}.bind(this))},e.prototype.update=function(){this.setColliderFlag(this.data.enabled)},e.prototype.setColliderFlag=function(t){var e=this.el.object3D;e&&(console.log("Setting collider flag to",t),a(e.userData,["altspace","collider","enabled"],t),e.traverse(function(e){e instanceof THREE.Mesh&&a(e.userData,["altspace","collider","enabled"],t)}))},Object.defineProperties(e.prototype,n),e}(P),N=function(t){function e(){t.apply(this,arguments)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.init=function(){this.gamepadIndex=null,this.trackedControlsSystem=document.querySelector("a-scene").systems["tracked-controls"],this.systemGamepads=0,altspace.getGamepads()},e.prototype.tick=function(){if(this.trackedControlsSystem&&this.systemGamepads!==this.trackedControlsSystem.controllers.length&&window.altspace&&altspace.getGamepads&&altspace.getGamepads().length){var t=this.el.components;t["paint-controls"]&&(this.gamepadIndex="left"===t["paint-controls"].data.hand?2:1),null===this.gamepadIndex&&t["hand-controls"]&&(this.gamepadIndex="left"===t["hand-controls"].data?2:1),null===this.gamepadIndex&&t["vive-controls"]&&(this.gamepadIndex="left"===t["vive-controls"].data.hand?2:1),null===this.gamepadIndex&&t["tracked-controls"]&&(this.gamepadIndex=t["tracked-controls"].data.controller),this.el.setAttribute("tracked-controls","id",altspace.getGamepads()[this.gamepadIndex].id),this.el.setAttribute("tracked-controls","controller",0),this.systemGamepads=this.trackedControlsSystem.controllers.length}},e}(P),U=function(t){function e(){t.apply(this,arguments)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={schema:{}};return n.schema.get=function(){return{usePixelScale:{type:"boolean",default:"false"},verticalAlign:{type:"string",default:"middle"},enclosuresOnly:{type:"boolean",default:"true"},fullspace:{type:"boolean",default:"false"}}},e.prototype.init=function(){return this.version="AFRAME_ALTSPACE_VERSION",!this.el.object3D instanceof THREE.Scene?void console.warn("aframe-altspace-component can only be attached to a-scene"):void(window.altspace&&window.altspace.inClient?(this.el.setAttribute("vr-mode-ui",{enabled:!1}),this.initRenderer(),this.initCursorEvents(),this.initCollisionEvents()):console.warn("aframe-altspace-component only works inside of AltspaceVR"))},e.prototype.tick=function(t,e){this.el.object3D.updateAllBehaviors&&this.el.object3D.updateAllBehaviors()},e.prototype.initRenderer=function(){var t=this,e=this.el.object3D;altspace.getEnclosure().then(function(o){switch(t.data.fullspace&&(o.requestFullspace(),o.addEventListener("fullspacechange",function(){e.scale.setScalar(o.pixelsPerMeter)})),t.data.usePixelScale&&!t.data.fullspace||e.scale.setScalar(o.pixelsPerMeter),t.data.verticalAlign){case"bottom":e.position.y-=o.innerHeight/2;break;case"top":e.position.y+=o.innerHeight/2;break;case"middle":break;default:console.warn("Unexpected value for verticalAlign: ",t.data.verticalAlign)}t.data.enclosuresOnly&&1===o.innerDepth&&(t.el.renderer.render(new THREE.Scene),t.el.renderer=t.el.effect=n)}.bind(this));var n=this.el.renderer,o=this.el.renderer=this.el.effect=altspace.getThreeJSRenderer({aframeComponentVersion:this.version}),i=function(){};o.setSize=i,o.setPixelRatio=i,o.setClearColor=i,o.clear=i,o.enableScissorTest=i,o.setScissor=i,o.setViewport=i,o.getPixelRatio=i,o.getMaxAnisotropy=i,o.setFaceCulling=i,o.context={canvas:{}},o.shadowMap={}},e.prototype.initCursorEvents=function(){function t(t,e){var o=e.target.el;n&&n.emit(t,{target:o,ray:e.ray,point:e.point}),o&&o.emit(t,{target:o,ray:e.ray,point:e.point})}var e=this.el.object3D,n=document.querySelector("a-cursor")||document.querySelector("a-entity[cursor]");n&&(n.setAttribute("material","transparent",!0),n.setAttribute("material","opacity",0));var o=null;e.addEventListener("cursordown",function(e){o=e.target,t("mousedown",e)}),e.addEventListener("cursorup",function(e){t("mouseup",e),e.target.uuid===o.uuid&&t("click",e),o=null}),e.addEventListener("cursorenter",function(e){e.target.el&&(e.target.el.addState("hovered"),n&&n.addState("hovering"),t("mouseenter",e))}),e.addEventListener("cursorleave",function(e){e.target.el&&(e.target.el.removeState("hovered"),n&&n.removeState("hovering"),t("mouseleave",e))})},e.prototype.initCollisionEvents=function(){function t(t,e){var n=e.target.el;n&&(e.target=n,e.other&&e.other.el&&(e.other=e.other.el),n.emit(t,e))}var e=this.el.object3D;e.addEventListener("collisionenter",function(e){t("collisionenter",e)}),e.addEventListener("collisionexit",function(e){t("collisionexit",e)}),e.addEventListener("triggerenter",function(e){t("triggerenter",e)}),e.addEventListener("triggerexit",function(e){t("triggerexit",e)})},Object.defineProperties(e.prototype,n),e}(P),z=function(t){function e(){t.apply(this,arguments)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={dependencies:{}};return n.dependencies.get=function(){return["sync"]},e.prototype.init=function(){this.sync=this.el.components.sync,this.sync.isConnected?start():this.el.addEventListener("connected",this.start.bind(this))},e.prototype.start=function(){var t=this.sync.dataRef.child("material/color"),e=!1,n=!0;this.el.addEventListener("componentchanged",function(n){var o=n.detail.name,i=n.detail.oldData,s=n.detail.newData;"material"===o&&!e&&i.color!==s.color&&sync.isMine&&setTimeout(function(){return t.set(s.color)},0)});var o=this;t.on("value",function(t){if(!o.sync.isMine||n){var i=t.val();e=!0,o.el.setAttribute("material","color",i),e=!1,n=!1}})},Object.defineProperties(e.prototype,n),e}(P),V=function(t){function e(t){void 0===t&&(t=!1),this._isComponent=t,this.scene=void 0,this.syncSys=void 0,this.ref=void 0,this.key=void 0,this.dataRef=void 0,this.ownerRef=void 0,this.ownerId=void 0,this.isConnected=!1,this.isMine=!1}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={schema:{}};return n.schema.get=function(){return{mode:{default:"link"},ownOn:{type:"string"}}},e.prototype.init=function(){var t=this;if(this.scene=this.el.sceneEl,this.syncSys=this.scene.systems["sync-system"],this.syncSys.isConnected?start():this.scene.addEventListener("connected",this.start.bind(this)),this.data.ownOn){var e=this.data.ownOn.split(/[ ,]+/);e.forEach(function(e){t.el.addEventListener(e,function(){t.isConnected&&t.takeOwnership()}.bind(t))}.bind(this))}},e.prototype.takeOwnership=function(){this.ownerRef.set(this.syncSys.clientId),this.ownerRef.onDisconnect().set(null)},e.prototype.start=function(){var t=this;if(this.scene.addEventListener("clientleft",function(e){var n=(!ownerId||ownerId===e.detail.id)&&t.syncSys.isMasterClient;n&&t.takeOwnership()}.bind(this)),"link"!==this.data.mode)return void console.error("Unsupported sync mode: "+this.data.mode);var e=this.el.id;return e?(console.log("syncSys: "+this.syncSys),console.log("syncSys.sceneRef: "+this.syncSys.sceneRef),this.link(this.syncSys.sceneRef.child(e)),this.setupReceive(),this.isConnected=!0,void this.el.emit("connected",null,!1)):void console.error("Entities cannot be synced using link mode without an id.")},e.prototype.link=function(t){this.ref=t,this.key=this.ref.key(),this.dataRef=this.ref.child("data"),this.ownerRef=this.ref.child("owner")},e.prototype.setupReceive=function(){var t=this;this.ownerRef.transaction(function(e){if(!e)return t.ownerRef.onDisconnect().set(null),t.syncSys.clientId}.bind(this)),this.ownerRef.on("value",function(e){var n=e.val(),o=n===t.syncSys.clientId&&!t.isMine;o&&t.el.emit("ownershipgained",null,!1);var i=n!==t.syncSys.clientId&&t.isMine;i&&(t.el.emit("ownershiplost",null,!1),t.ownerRef.onDisconnect().cancel()),t.ownerId=n,t.isMine=n===t.syncSys.clientId}.bind(this))},Object.defineProperties(e.prototype,n),e}(P),F=function(t){function e(){t.apply(this,arguments)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={schema:{}};return n.schema.get=function(){return{author:{type:"string",default:null},app:{type:"string",default:null},instance:{type:"string",default:null},refUrl:{type:"string",default:null}}},e.prototype.init=function(){return this.data&&this.data.app?(console.log(this.data),this.isConnected=!1,void altspace.utilities.sync.connect({authorId:this.data.author,appId:this.data.app,instanceId:this.data.instance,baseRefUrl:this.data.refUrl}).then(this.connected.bind(this))):void console.warn("The sync-system must be present on the scene and configured with required data.")},e.prototype.connected=function(t){this.connection=t,this.sceneRef=this.connection.instance.child("scene"),this.clientsRef=this.connection.instance.child("clients"),this.clientId=this.sceneEl.object3D.uuid,this.masterClientId=null;var e=this;this.clientsRef.on("value",function(t){var n=t.val(),o=Object.keys(n)[0];e.masterClientId=n[o]}),this.clientsRef.on("child_added",function(t){var n=t.val();setTimeout(function(){e.sceneEl.emit("clientjoined",{id:n},!1)},0)}),this.clientsRef.on("child_removed",function(t){var n=t.val();setTimeout(function(){e.sceneEl.emit("clientleft",{id:n},!1)},0)}),this.clientsRef.push(this.clientId).onDisconnect().remove(),this.connection.instance.child("initialized").once("value",function(t){var n=!t.val();t.ref().set(!0),e.sceneEl.emit("connected",{shouldInitialize:n},!1),e.isConnected=!0})},e.prototype.isMasterClient=function(){return this.masterClientId===this.clientId},Object.defineProperties(e.prototype,n),e}(k);AFRAME.registerComponent("sync-transform",{dependencies:["sync"],schema:{},init:function(){function t(){function t(t,o){if(!n.isMine){var i=t.val();i&&e.el.setAttribute(o,i)}}function o(t){if(n.isMine){var e=t.detail.name,o=t.detail.newData;if("position"===e)l(o);else if("rotation"===e)d(o);else{if("scale"!==e)return;h(o)}}}function i(t,e,n){var o,i,s,r,a=0;n||(n={});var c=function(){a=n.leading===!1?0:Date.now(),o=null,r=t.apply(i,s),o||(i=s=null)},l=function(){var l=Date.now();a||n.leading!==!1||(a=l);var d=e-(l-a);return i=this,s=arguments,d<=0||d>e?(o&&(clearTimeout(o),o=null),a=l,r=t.apply(i,s),o||(i=s=null)):o||n.trailing===!1||(o=setTimeout(c,d)),r};return l.cancel=function(){clearTimeout(o),a=0,o=i=s=null},l}var s=n.dataRef.child("position"),r=n.dataRef.child("rotation"),a=n.dataRef.child("scale");e.updateRate=100;var c=[];e.el.addEventListener("ownershiplost",function(){for(var t=e.el.children,n=0;n<t.length;n++){var o=t[n].tagName.toLowerCase();"a-animation"===o&&(c.push(t[n]),t[n].stop())}}),e.el.addEventListener("ownershipgained",function(){for(var t=0;t<c.length;t++){var e=c[t];e.start()}c=[]}),s.on("value",function(e){t(e,"position")}),r.on("value",function(e){t(e,"rotation")}),a.on("value",function(e){t(e,"scale")});var l=i(function(t){s.set(t)},e.updateRate),d=i(function(t){r.set(t)},e.updateRate),h=i(function(t){a.set(t)},e.updateRate);e.el.addEventListener("componentchanged",o)}var e=this,n=e.el.components.sync;n.isConnected?t():e.el.addEventListener("connected",t)}});(function(t){function e(){t.apply(this,arguments)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={dependencies:{}};return n.dependencies.get=function(){return["sync"]},Object.defineProperties(e.prototype,n),e})(P);AFRAME.registerComponent("sync-n-sound",{dependencies:["sync"],schema:{},init:function(){function t(){function t(t){if(n.isMine){var t={type:t.type,sender:i.clientId,el:e.el.id,time:Date.now()};e.soundEventRef.set(t)}}e.soundStateRef=n.dataRef.child("sound/state"),e.soundEventRef=n.dataRef.child("sound/event"),e.el.addEventListener("sound-played",t),e.el.addEventListener("sound-paused",t),e.soundEventRef.on("value",function(t){if(!n.isMine){var o=t.val();if(o&&o.el===e.el.id){var i=e.el.components["n-sound"];"sound-played"===o.type?i.playSound():i.pauseSound()}}}),e.el.addEventListener("componentchanged",function(t){if(n.isMine){var o=t.detail.name;"n-sound"===o&&e.soundStateRef.set(t.detail.newData)}}),e.soundStateRef.on("value",function(t){if(!n.isMine){var o=t.val();o&&e.el.setAttribute("n-sound",o)}})}var e=this,n=e.el.components.sync,o=document.querySelector("a-scene"),i=o.systems["sync-system"];n.isConnected?t():e.el.addEventListener("connected",t)},remove:function(){this.soundStateRef.off("value"),this.soundEventRef.off("value")}}),AFRAME.registerComponent("wire",{multiple:!0,schema:{on:{type:"string"},emit:{type:"string"},gained:{type:"string"},lost:{type:"string"},gain:{type:"string"},lose:{type:"string"},targets:{type:"selectorAll"},target:{type:"selector"}},update:function(t){t.on&&this.el.removeEventListener(t.on,this.actOnTargets),t.gained&&this.el.removeEventListener("stateadded",this.actOnTargetsIfStateMatches),t.lost&&this.el.removeEventListener("stateremoved",this.actOnTargetsIfStateMatches),this.actOnTargets=function(){function t(t){this.data.emit&&t.emit(this.data.emit),this.data.gain&&t.addState(this.data.gain),this.data.lose&&t.removeState(this.data.lose)}this.data.targets&&this.data.targets.forEach(t.bind(this)),this.data.target&&t.call(this,this.data.target)}.bind(this),this.actOnTargetsIfStateMatches=function(t){var e=t.detail.state;e!==this.data.gained&&e!==this.data.lost||this.actOnTargets()}.bind(this),this.data.on&&this.el.addEventListener(this.data.on,this.actOnTargets),this.data.gained&&this.el.addEventListener("stateadded",this.actOnTargetsIfStateMatches),this.data.lost&&this.el.addEventListener("stateremoved",this.actOnTargetsIfStateMatches)},remove:function(){this.el.removeEventListener(this.data.on,this.actOnTargets),this.el.removeEventListener("stateadded",this.actOnTargetsIfStateMatches),this.el.removeEventListener("stateremoved",this.actOnTargetsIfStateMatches)}}),window.AFRAME&&(r("sync-system",F),s("altspace-cursor-collider",B),s("altspace-tracked-controls",N),s("altspace",U),s("sync-color",z),s("sync",V));var q,G,W,J,X=Object.freeze({AltspaceComponent:U,AltspaceCursorCollider:B,AltspaceTrackedControls:N,SyncSystem:F,SyncComponent:V,SyncColor:z,flatten:i}),Y=altspace&&altspace.inClient,Q=l(),Z=Object.freeze({connect:h}),K=new THREE.Raycaster,$=Object.freeze({init:u});window.altspace=window.altspace||{},window.altspace.utilities=window.altspace.utilities||{};var tt=function(t){var e=t.auto;void 0===e&&(e=!0),this._scene=null,this._renderer=null,this._camera=null;var n=window.AFRAME&&document.querySelector("a-scene");if(n){var o=document.querySelector("a-scene");this._scene=o.object3D,this._renderer=o.renderer;var i=document.querySelector("a-camera");i&&(this._camera=i.object3D)}else window.altspace&&altspace.inClient?(this._scene=new THREE.Scene,this._renderer=altspace.getThreeJSRenderer(),this._camera=new THREE.PerspectiveCamera):this._setupWebGL();e&&!n&&this.loop()},et={scene:{},renderer:{},camera:{}};tt.prototype._setupWebGL=function(){function t(){o.aspect=window.innerWidth/window.innerHeight,o.updateProjectionMatrix(),n.setSize(window.innerWidth,window.innerHeight)}var e=this._scene=new THREE.Scene,n=this._renderer=new THREE.WebGLRenderer({antialias:!0}),o=this._camera=new THREE.PerspectiveCamera;document.addEventListener("DOMContentLoaded",function(t){document.body.style.margin="0px",document.body.style.overflow="hidden",n.setClearColor("#035F72");var e=document.createElement("div");document.body.appendChild(e),e.appendChild(n.domElement)}),window.addEventListener("resize",t),t(),o.position.z=500,o.fov=45,o.near=1,o.far=2e3,e.add(o),e.add(new THREE.AmbientLight("white")),this.cursor=u(e,o)},tt.prototype.loop=function(){window.requestAnimationFrame(this.loop.bind(this)),this.scene.updateAllBehaviors&&this.scene.updateAllBehaviors(),this.renderer.render(this.scene,this.camera)},et.scene.get=function(){return this._scene},et.renderer.get=function(){return this._renderer},et.camera.get=function(){return this._camera},Object.defineProperties(tt.prototype,et);var nt,ot,it="",st="",rt=Object.freeze({init:E,load:j,LoadRequest:m}),at="VR CodePen",ct=window.name&&"pen-"===window.name.slice(0,4),lt=!!window.altspace.inClient,dt=!!location.href.match("codepen.io/"),ht=Object.freeze({inTile:ct,inVR:lt,inCodePen:dt,ensureInVR:R,setName:O,getPenId:S,getAuthorId:L,printDebugInfo:_}),pt=function(){};pt.prototype.load=function(t,e,n){var o=new THREE.MTLLoader,i=e.split("/").slice(0,-1).join("/");o.setBaseUrl(i+"/"),o.setCrossOrigin(this.crossOrigin),o.load(e,function(e){var o=new THREE.OBJLoader;o.setMaterials(e),o.load(t,n)})},THREE&&!altspace.inClient&&(THREE.EventDispatcher.prototype.dispatchEvent=C,THREE.Object3D.prototype.dispatchEvent=C),THREE.Scene.prototype.updateAllBehaviors=function(){var t=performance.now(),e=this.__lastNow||t,n=t-e,o=this,i=[];this.traverse(function(t){t.__behaviorList&&i.push(t)});for(var s=0,r=i.length;s<r;s++){var a=i[s];a.updateBehaviors(n,o)}this.__lastNow=t},THREE.Object3D.prototype.addBehavior=function(t){this.addBehaviors(t)},THREE.Object3D.prototype.addBehaviors=function(){for(var t=[],e=arguments.length;e--;)t[e]=arguments[e];this.__behaviorList=this.__behaviorList||[],(n=this.__behaviorList).push.apply(n,t);var n},THREE.Object3D.prototype.removeBehavior=function(t){if(!this.__behaviorList||0===this.__behaviorList.length)return null;var e=this.__behaviorList.indexOf(t);if(e!==-1){this.__behaviorList.splice(e,1);try{t.dispose&&t.dispose.call(t,this)}catch(e){console.group(),(console.error||console.log).call(console,e.stack||e),console.log("[Behavior]"),console.log(t),console.log("[Object3D]"),console.log(this),console.groupEnd()}}},THREE.Object3D.prototype.removeAllBehaviors=function(){var t=this;if(!this.__behaviorList||0===this.__behaviorList.length)return null;for(var e=0,n=this.__behaviorList.length;e<n;e++){var o=t.__behaviorList[e];try{o.dispose&&o.dispose.call(o,t)}catch(e){console.group(),(console.error||console.log).call(console,e.stack||e),console.log("[Behavior]"),console.log(o),console.log("[Object3D]"),console.log(t),console.groupEnd()}}this.__behaviorList.length=0},THREE.Object3D.prototype.getBehaviorByType=function(t){var e=this;if(!this.__behaviorList||0===this.__behaviorList.length)return null;for(var n=0,o=this.__behaviorList.length;n<o;n++)if(e.__behaviorList[n].type===t)return e.__behaviorList[n]},THREE.Object3D.prototype.updateBehaviors=function(t,e){var n=this;if(this.__behaviorList&&0!==this.__behaviorList.length){for(var o=[],i=this.__behaviorList.slice(),s=0,r=this.__behaviorList.length;s<r;s++){var a=n.__behaviorList[s];a.__isInitialized||o.push(a)}for(var s=0,r=o.length;s<r;s++){var a=o[s];try{a.awake&&a.awake.call(a,n,e)}catch(t){console.group(),(console.error||console.log).call(console,t.stack||t),console.log("[Behavior]"),console.log(a),console.log("[Object3D]"),console.log(n),console.groupEnd()}}for(var s=0,r=o.length;s<r;s++){var a=o[s];try{a.start&&a.start.call(a)}catch(t){console.group(),(console.error||console.log).call(console,t.stack||t),console.log("[Behavior]"),console.log(a),console.log("[Object3D]"),console.log(n),console.groupEnd()}a.__isInitialized=!0}for(var s=0,r=i.length;s<r;s++){var a=i[s];try{a.update&&a.update.call(a,t)}catch(t){console.group(),(console.error||console.log).call(console,t.stack||t),console.log("[Behavior]"),console.log(a),console.log("[Object3D]"),console.log(n),console.groupEnd()}}}};var ut=Object.freeze({OBJMTLLoader:pt,cursor:$}),ft=function(){},vt={type:{}};vt.type.get=function(){return this._typeWarning||(console.warn("Behavior",this,"does not expose type information!","It will not be queryable by getBehaviorByType, which will break","some built-in behaviors."),this._typeWarning=!0),null},ft.prototype.awake=function(t,e){},ft.prototype.start=function(){},ft.prototype.update=function(t){},ft.prototype.dispose=function(t){},Object.defineProperties(ft.prototype,vt);var yt=function(t){function e(t){this.config=Object.assign({x:3,y:5,shouldRotate:!0,shouldMove:!0},t),this.object3d=null,this.offsetPosition=null,this.lastBobPosition=new THREE.Vector3,this.nowOffset=1e4*Math.random()}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"Bob"},e.prototype.awake=function(t){this.object3d=t,this.offsetPosition=object3D.position.clone()},e.prototype.update=function(t){var e=Math.floor(performance.now())+this.nowOffset;this.config.shouldMove&&(this.lastBobPosition.equals(this.object3d.position)||this.offsetPosition.copy(this.object3d.position),this.object3d.position.y+=Math.sin(e/800)*this.config.x,this.object3d.position.x+=Math.sin(e/500)*this.config.y,this.lastBobPosition.copy(this.object3d.position)),this.config.shouldRotate&&(object3d.rotation.x=Math.sin(e/500)/15)},Object.defineProperties(e.prototype,n),e}(ft),gt=function(t){function e(t){this.config=Object.assign({overBrightness:1.5,downBrightness:.5},t),this.object3d=null,this.scene=null,this.originalColor=null,this.modifiedColor=new THREE.Color,this._cbs={cursorenter:this.cursorEnter.bind(this),cursordown:this.cursorDown.bind(this),cursorup:this.cursorUp.bind(this),cursorleave:this.cursorLeave.bind(this)}}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"ButtonStateStyle"},e.prototype.awake=function(t,e){this.object3d=t,this.scene=e,this.originalColor=this.config.originalColor||object3d.material.color,this.object3d.addEventListener("cursorenter",this._cbs.cursorenter),this.object3d.addEventListener("cursordown",this._cbs.cursordown)},e.prototype.dispose=function(){this.object3d.removeEventListener("cursorenter",this._cbs.cursorenter),this.object3d.removeEventListener("cursorleave",this._cbs.cursorleave),this.object3d.removeEventListener("cursorup",this._cbs.cursorup),this.object3d.removeEventListener("cursordown",this._cbs.cursordown)},e.prototype.changeBrightness=function(t){this.modifiedColor.set(this.originalColor),this.modifiedColor.multiplyScalar(t),this.modifiedColor.r=THREE.Math.clamp(this.modifiedColor.r,0,1),this.modifiedColor.g=THREE.Math.clamp(this.modifiedColor.g,0,1),this.modifiedColor.b=THREE.Math.clamp(this.modifiedColor.b,0,1),this.object3d.material.color=this.modifiedColor},e.prototype.cursorLeave=function(){this.object3d.removeEventListener("cursorleave",this._cbs.cursorleave),this.changeBrightness(1)},e.prototype.cursorEnter=function(){this.changeBrightness(this.config.overBrightness),object3d.addEventListener("cursorleave",this._cbs.cursorleave)},e.prototype.cursorUp=function(t){this.scene.removeEventListener("cursorup",this._cbs.cursorup),this.object3d.addEventListener("cursorenter",this._cbs.cursorenter),t.target===this.object3d?(this.changeBrightness(this.config.overBrightness),this.object3d.addEventListener("cursorleave",this._cbs.cursorleave)):this.changeBrightness(1)},e.prototype.cursorDown=function(){this.scene.addEventListener("cursorup",this._cbs.cursorup),this.object3d.removeEventListener("cursorleave",this._cbs.cursorleave),this.object3d.removeEventListener("cursorenter",this._cbs.cursorenter),this.changeBrightness(this.config.downBrightness)},Object.defineProperties(e.prototype,n),e}(ft),bt=function(t){function e(t){this.config=t=Object.assign({space:"world",x:!1,y:!1,z:!1,cursorSnap:!0},t),this.min=new THREE.Vector3(void 0!==t.x.min?t.x.min:Number.NEGATIVE_INFINITY,void 0!==t.y.min?t.y.min:Number.NEGATIVE_INFINITY,void 0!==t.z.min?t.z.min:Number.NEGATIVE_INFINITY),this.max=new THREE.Vector3(void 0!==t.x.max?t.x.max:Number.POSITIVE_INFINITY,void 0!==t.y.max?t.y.max:Number.POSITIVE_INFINITY,void 0!==t.z.max?t.z.max:Number.POSITIVE_INFINITY),this.object3d=null,this.scene=null,this.sync=null,this.intersector=null,this.dragOffset=new THREE.Vector3,this.raycaster=new THREE.Raycaster,this.raycaster.linePrecision=3,this._cbs={startDrag:this.startDrag.bind(this),moveDrag:this.moveDrag.bind(this),stopDrag:this.stopDrag.bind(this)
}}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"Drag"},e.prototype.awake=function(t,e){this.object3d=t,this.scene=e,this.sync=t.getBehaviorByType("Object3DSync"),this.makeIntersector(),this.scene.add(this.intersector)},e.prototype.start=function(){this.object3d.addEventListener("cursordown",this._cbs.startDrag)},e.prototype.dispose=function(){this.object3d.removeEventListener("cursordown",this._cbs.startDrag)},e.prototype.makeIntersector=function(){function t(){i.rotateY(Math.PI)}function e(){i.rotateX(Math.PI/2)}function n(){i.rotateY(Math.PI/2)}var o=1e4,i=new THREE.PlaneGeometry(o,o),s=!!this.config.x,r=!!this.config.y,a=!!this.config.z,c=s+r+a;if(3===c)throw new Error("Arbitrary dragging currently unsupported. Please lock at least one axis.");if(2!==c)throw 1===c?new Error("Single axis dragging currently unsupported."):new Error("Invalid axis configuration");s&&r?t():s&&a?e():r&&a&&n();var l=new THREE.MeshBasicMaterial({color:"purple"});l.side=THREE.DoubleSide,this.intersector=new THREE.Mesh(i,l),this.intersector.visible=!1,this.intersector.material.visible=!1},e.prototype.startDrag=function(t){this.scene.addEventListener("cursorup",this._cbs.stopDrag),this.scene.addEventListener("cursormove",this._cbs.moveDrag),this.raycaster.set(t.ray.origin,t.ray.direction);var e=raycaster.intersectObject(object3d,!0)[0];if(e){var n=e.point.clone(),o=I(this.object3d).clone();this.dragOffset.copy(n).sub(o),this.intersector.position.copy(this.intersector.parent.worldToLocal(n)),this.intersector.quaternion.copy(this.object3d.parent.quaternion),this.intersector.updateMatrixWorld();var i=this.createDragEvent("dragstart");this.object3d.dispatchEvent(i)}},e.prototype.moveDrag=function(t){this.sync&&!this.sync.isMine&&this.sync.takeOwnership(),this.intersector.visible=!0,this.raycaster.set(t.ray.origin,t.ray.direction);var e=this.raycaster.intersectObject(this.intersector,!0)[0];if(this.intersector.visible=!1,e){var n=new THREE.Vector3;n.copy(e.point).sub(this.dragOffset);var o=this,i=I(this.object3d);["x","y","z"].filter(function(t){return!o.config[t]}).forEach(function(t){n[t]=i[t]}),n.clamp(min,max),this.object3d.parent.updateMatrixWorld();var s=this.object3d.parent.worldToLocal(n);this.object3d.position.set(this.config.x?s.x:this.object3d.position.x,this.config.y?s.y:this.object3d.position.y,this.config.z?s.z:this.object3d.position.z)}},e.prototype.stopDrag=function(){this.scene.removeEventListener("cursorup",this._cbs.stopDrag),this.scene.removeEventListener("cursormove",this._cbs.moveDrag);var t=this.createDragEvent("dragstop");this.object3d.dispatchEvent(t)},e.prototype.createDragEvent=function(t){return{type:t,bubbles:!0,target:this.object3d,ray:this.raycaster.ray.clone()}},Object.defineProperties(e.prototype,n),e}(ft),mt=.2,Et=function(t){function e(t){this.config=Object.assign({position:!0,rotation:!0,scale:!0},t),this.object3d=null,this.gamepad=null,this.scene=null,this.sync=null,this.isAltModeR=!1,this.isAltModeL=!1,this.prevAltButtonR=!1,this.prevAltButtonL=!1,this.isInitialized=!1,this.originalObj=null}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"GamepadControls"},e.prototype.awake=function(t,e){var n=this;if(this.object3d=t,this.scene=e,this.sync=this.object3d.getBehaviorByType("Object3DSync"),this.originalObj=object3d.clone(),this.gamepad=this.getGamepad(),this.gamepad)console.log("Gamepad detected: "+this.gamepad.id);else var o=setInterval(function(){n.gamepad=n.getGamepad(),n.gamepad&&(console.log("Gamepad connected: "+n.gamepad.id),clearInterval(o))}.bind(this),500);this.scene.addEventListener("cursordown",function(t){n.gamepad&&!n.isInitialized&&(n.preventDefault(n.gamepad),n.isInitialized=!0)}.bind(this))},e.prototype.getGamepad=function(){var t=this,e=[];if(e=altspace&&altspace.inClient?altspace.getGamepads():navigator.getGamepads(),e.length>0)for(var n=0;n<e.length;n++){var o=e[n];if(o&&o.axes&&4===o.axes.length&&o.buttons&&16===o.buttons.length)return altspace&&altspace.inClient&&t.preventDefault(o),o}},e.prototype.preventDefault=function(t){var e=new Array(4).fill(!1),n=new Array(16).fill(!1);this.config.position&&(e[0]=!0,e[1]=!0,n[10]=!0),this.config.rotation&&(e[2]=!0,e[3]=!0,n[11]=!0),this.config.scale&&(n[12]=!0,n[13]=!0),n[8]=!0,t.preventDefault(e,n)},e.prototype.update=function(t){if(altspace&&altspace.inClient||!window.chrome||!this.gamepad||(this.gamepad=this.getGamepad()),this.gamepad){var e=this.gamepad.buttons[8].pressed;if(e)return this.sync.isMine||this.sync.takeOwnership(),this.object3d.position.copy(this.originalObj.position),this.object3d.rotation.copy(this.originalObj.rotation),void this.object3d.scale.copy(this.originalObj.scale);if(this.config.position){var n=this.gamepad.buttons[10].pressed;this.prevAltButtonL&&!n&&(this.isAltModeL=!this.isAltModeL),this.prevAltButtonL=n;var o=gamepad.axes[0],i=gamepad.axes[1],s=Math.abs(o)>mt||Math.abs(i)>mt;s&&!this.sync.isMine&&this.sync.takeOwnership();var r=200*(t/1e3);Math.abs(o)>mt&&(this.object3d.position.x+=r*o),Math.abs(i)>mt&&(this.isAltModeL?this.object3d.position.y+=r*-i:this.object3d.position.z+=r*i)}if(this.config.rotation){var a=this.gamepad.buttons[11].pressed;this.prevAltButtonR&&!a&&(this.isAltModeR=!this.isAltModeR),prevAltButtonR=a;var c=gamepad.axes[2],l=gamepad.axes[3],d=Math.abs(c)>mt||Math.abs(l)>mt;d&&!this.sync.isMine&&this.sync.takeOwnership();var h=Math.PI*(t/1e3);!this.isAltModeR&&Math.abs(l)>mt&&(this.object3d.rotation.x+=h*l),Math.abs(c)>mt&&(this.isAltModeR?this.object3d.rotation.z+=h*-c:this.object3d.rotation.y+=h*c)}if(this.config.scale){var p=10*(t/1e3),u=this.gamepad.buttons[12].pressed,f=this.gamepad.buttons[13].pressed,v=this.gamepad.buttons[12].pressed||this.gamepad.buttons[13].pressed;v&&!this.sync.isMine&&this.sync.takeOwnership();var y=this.object3d.scale,g=new THREE.Vector3(1,1,1);g.multiplyScalar(p),u&&this.object3d.scale.add(g),f&&y.x>g.x&&y.y>g.y&&y.z>g.z&&this.object3d.scale.sub(g)}}},Object.defineProperties(e.prototype,n),e}(ft),jt=function(t){function e(t){var e=this;if(this.config=Object.assign({event:"cursorenter",color:new THREE.Color("yellow")},t),"cursorenter"!==t.event&&"cursordown"!==t.event)throw Error('Expected config.event "cursorenter" or "cursordown"');this.object3d=null,this.cursordownObject=null,this.cursorenterObject=null,this.scene=null,this.cursordown=function(t){e.cursordownObject=e.object3d,"cursordown"===e.config.event&&e.setColor(cursordownObject)}.bind(this),this.cursorenter=function(t){e.cursordownObject&&e.cursordownObject!==e.object3d||(e.cursorenterObject&&e.unsetColor(e.cursorenterObject),e.cursorenterObject=e.object3d,e.setColor(e.object3d))}.bind(this),this.cursorleave=function(t){e.cursorenterObject===e.object3d&&(e.cursorenterObject=null,e.unsetColor(e.object3d))}.bind(this),this.cursorupScene=function(t){"cursordown"===e.config.event&&e.cursordownObject&&e.unsetColor(e.cursordownObject),e.cursordownObject=null}.bind(this)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"HoverColor"},e.prototype.awake=function(t,e){this.object3d=t,this.scene=e,this.object3d.addEventListener("cursordown",this.cursordown),this.scene.addEventListener("cursorup",this.cursorupScene),"cursorenter"===this.config.event&&(this.object3d.addEventListener("cursorenter",this.cursorenter),this.object3d.addEventListener("cursorleave",this.cursorleave))},e.prototype.dispose=function(){this.object3d.removeEventListener("cursordown",this.cursordown),this.scene.removeEventListener("cursorup",this.cursorupScene),this.object3d.removeEventListener("cursorenter",this.cursorenter),this.object3d.removeEventListener("cursorleave",this.cursorleave)},e.prototype.setColor=function(t){t.material&&t.material.color&&(t.userData.origColor=t.material.color,t.material.color=this.config.color,t.material&&(t.material.needsUpdate=!0)),t.children.forEach(this.setColor.bind(this))},e.prototype.unsetColor=function(t){if(t.material&&t.material.color){if(!t.userData.origColor)return void console.error("Cannot unsetColor, no userData.origColor for object",t);t.material.color=t.userData.origColor,t.material&&(t.material.needsUpdate=!0)}t.children.forEach(this.unsetColor.bind(this))},Object.defineProperties(e.prototype,n),e}(ft),wt=function(t){function e(t){var e=this;this.config=Object.assign({scale:1.15,duration:75,revertOnDispose:!0},t),this.object3d=null,this.originalScale=null,this.elapsedTime=null,this.progress=null,this.srcScale=null,this.destScale=null,this.onHoverStateChange=function(){var t;t=[e.destScale,e.srcScale],e.srcScale=t[0],e.destScale=t[1],e.progress=1-e.progress,e.elapsedTime=e.duration-e.elapsedTime}.bind(this)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"HoverScale"},e.prototype.awake=function(t,e){this.object3d=t,this.originalScale=this.object3d.scale.clone(),this.srcScale=this.object3d.scale.clone(),this.srcScale.multiplyScalar(this.config.scale),this.destScale=new THREE.Vector3,this.destScale.copy(this.originalScale),this.progress=1,this.elapsedTime=this.config.duration,this.object3d.addEventListener("cursorenter",this.onHoverStateChange),this.object3d.addEventListener("cursorleave",this.onHoverStateChange)},e.prototype.update=function(t){this.progress<1&&(this.elapsedTime=THREE.Math.clamp(this.elapsedTime+t,0,this.config.duration),this.progress=THREE.Math.clamp(this.elapsedTime/this.config.duration,0,1),this.object3d.scale.lerpVectors(this.srcScale,this.destScale,this.progress))},e.prototype.dispose=function(){this.object3d.removeEventListener("cursorenter",this.onHoverStateChange),this.object3d.removeEventListener("cursorleave",this.onHoverStateChange),this.config.revertOnDispose&&this.object3d.scale.copy(this.originalScale),this.originalScale=null,this.srcScale=null,this.destScale=null,this.object3d=null},Object.defineProperties(e.prototype,n),e}(ft),_t=function(t){function e(t){this.config=Object.assign({jointCubeSize:15,joints:e.HAND_JOINTS},t),this.object3d=null,this.skeleton=null,this.jointCube=null,this.hasCollided=!1,this.collidedJoints=[],this.jointIntersectUnion=null}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"JointCollisionEvents"},e.prototype.awake=function(t,e){this.object3d=t;var n=this;x(e).then(function(t){n.skeleton=t,n.jointCube=new THREE.Vector3(n.config.jointCubeSize,n.config.jointCubeSize,n.config.jointCubeSize)}).catch(function(t){console.log("Failed to get tracking skeleton",t)})},e.prototype.update=function(t){var e=this;if(this.skeleton){for(var n=[],o=0;o<this.config.joints.length;o++)n[o]=e.skeleton.getJoint(e.config.joints[o][0],e.config.joints[o][1],e.config.joints[o][2]||0);var i=(new THREE.Box3).setFromObject(this.object3d);this.jointIntersectUnion;this.jointIntersectUnion=null;this.collidedJoints;this.collidedJoints=[];var s=this.hasCollided;if(this.hasCollided=!1,this.object3d.visible&&this.object3d.scale.x>Number.EPSILON&&this.object3d.scale.y>Number.EPSILON&&this.object3d.scale.z>Number.EPSILON)for(var r=0;r<this.config.joints.length;r++){var a=n[r];if(a&&0!==a.confidence){var c=(new THREE.Box3).setFromCenterAndSize(a.position,e.jointCube),l=i.intersectsBox(c);if(l){var d=i.intersect(c);e.jointIntersectUnion?e.jointIntersectUnion.union(d):e.jointIntersectUnion=d,e.hasCollided=!0,e.collidedJoints.push(a)}}}!s&&this.hasCollided?this.object3d.dispatchEvent(new Ot(this.jointIntersectUnion,this.collidedJoints,this.object3d)):s&&!this.hasCollided&&this.object3d.dispatchEvent(new Tt(this.prevJointIntersectUnion||new THREE.Box3,this.prevCollidedJoints,this.object3d)),this.hasCollided&&object3d.dispatchEvent(new CollsionEvent(this.jointIntersectUnion,this.collidedJoints,this.object3d))}},Object.defineProperties(e.prototype,n),e}(ft),Rt=function(t,e,n,o){this.type=t,this.detail={intersect:e,joints:n},this.bubbles=!0,this.target=o},Ot=function(t){function e(){for(var e=[],n=arguments.length;n--;)e[n]=arguments[n];t.apply(this,["jointcollisionenter"].concat(e))}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e}(Rt),Tt=function(t){function e(){for(var e=[],n=arguments.length;n--;)e[n]=arguments[n];t.apply(this,["jointcollisionleave"].concat(e))}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e}(Rt);_t.HAND_JOINTS=[["Hand","Left",0],["Thumb","Left",3],["Index","Left",3],["Middle","Left",3],["Ring","Left",3],["Pinky","Left",3],["Hand","Right",0],["Thumb","Right",3],["Index","Right",3],["Middle","Right",3],["Ring","Right",3],["Pinky","Right",3]];var St=Symbol("containerMax"),Lt=Symbol("containerMin"),Ct=Symbol("object3D"),It=Symbol("boundingBox"),xt=Symbol("origMatrix"),Mt=Symbol("origMatrixAutoUpdate"),Dt=Symbol("parent"),At=Symbol("enclosure"),kt=new Map,Ht=function(t){function e(t){var e=t.my;void 0===e&&(e={});var n=t.at;this.my=e,this.at=n}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"Layout"},e.prototype.getAxisSettings=function(t,e,n,o){e=e||"center",e=/(\w+)([-+].+)?/.exec(e);var i=e[1],s=e[2],r=parseFloat(s)||0;return s&&s.endsWith("%")?r=r/100*(o[t]-n[t]):s&&s.endsWith("m")&&(r*=this[At].pixelsPerMeter),{position:i,offset:r}},e.prototype.getAnchorOffset=function(t,e){var n=this[It].max,o=this[It].min,i=this.getAxisSettings(t,e,o,n),s=i.position,r=i.offset;if("max"===s)return-n[t]+r;if("min"===s)return-o[t]+r;if("center"===s)return r;throw new Error(e+" is an invalid layout position for "+t)},e.prototype.doLayout=function(){var t=this;Array.from("xyz").forEach(function(e){var n=t.getAxisSettings(e,t.at[e],t[Lt],t[St]),o=n.position,i=n.offset,s=t.getAnchorOffset(e,t.my[e]);if("max"===o)t[Ct].position[e]=t[St][e]+i+s;else if("min"===o)t[Ct].position[e]=t[Lt][e]+i+s;else{if("center"!==o)throw new Error(t.at[e]+" is an invalid layout position for "+e);t[Ct].position[e]=i+s}}),this[Dt]&&(this[Dt].matrix=this[xt],this[Dt].updateMatrixWorld(!0),this[Dt].matrixAutoUpdate=this[Mt])},e.prototype.awake=function(t){var e=this;this[Ct]=t,this[It]=(new THREE.Box3).setFromObject(this[Ct]),altspace.getEnclosure().then(function(t){if(e[At]=t,e[Ct].parent instanceof THREE.Scene){var n=e[At].innerWidth/2,o=e[At].innerHeight/2,i=e[At].innerDepth/2;e[St]=new THREE.Vector3(n,o,i),e[Lt]=new THREE.Vector3(-n,-o,-i),e.doLayout()}else{var s=e[Ct].getWorldScale();e[It].min.divide(s),e[It].max.divide(s),e[Dt]=e[Ct].parent,e[xt]=e[Dt].matrix.clone(),e[Mt]=e[Dt].matrixAutoUpdate,e[Dt].matrixAutoUpdate=!1,e[Dt].matrix.identity();var r;kt.has(e[Dt].uuid)?r=kt.get(e[Dt].uuid):(e[Dt].remove(e[Ct]),r=(new THREE.Box3).setFromObject(e[Dt]),e[Dt].add(e[Ct]),kt.set(e[Dt].uuid,r)),e[St]=r.max,e[Lt]=r.min,e.doLayout()}})},Object.defineProperties(e.prototype,n),e}(ft),Pt=function(t){function e(t){this.config=Object.assign({position:!1,rotation:!1,scale:!1,auto:!1,world:!1},t),this.object3d=null,this.scene=null,this.ref=null,this.key=null,this.dataRef=null,this.ownerRef=null,this.transformRef=null,this.sceneSync=null,this.isMine=!1,this.position=new THREE.Vector3,this.quaternion=new THREE.Quaternion,this.scale=new THREE.Vector3}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"Object3DSync"},e.prototype.awake=function(t,e){this.object3d=t,this.scene=e,this.setupReceive()},e.prototype.setupReceive=function(){var t=this;this.transformRef.on("value",function(e){var n=e.val();!t.isMine&&n&&(t.config.position&&t.object3d.position.set(n.position.x,n.position.y,n.position.z),t.config.rotation&&t.object3d.quaternion.set(n.quaternion.x,n.quaternion.y,n.quaternion.z,n.quaternion.w),t.config.scale&&t.object3d.scale.set(n.scale.x,n.scale.y,n.scale.z))}.bind(this)),this.ownerRef.on("value",function(e){var n=e.val();n!==t.sceneSync.clientId||t.isMine||t.object3d.dispatchEvent({type:"ownershipgained"}),n!==t.sceneSync.clientId&&t.isMine&&t.object3d.dispatchEvent({type:"ownershiplost"}),t.isMine=n===t.sceneSync.clientId}.bind(this))},e.prototype.link=function(t,e){this.ref=t,this.key=this.ref.key(),this.transformRef=this.ref.child("batch"),this.dataRef=this.ref.child("data"),this.ownerRef=this.ref.child("owner"),this.sceneSync=e},e.prototype.autoSend=function(){if(this.isMine){var t={};if(this.config.world?(this.object3d.updateMatrixWorld(),this.object3d.matrixWorld.decompose(this.position,this.quaternion,this.scale)):(this.position=this.object3d.position,this.quaternion=this.object3d.quaternion,this.scale=this.object3d.scale),this.config.position&&(t.position={x:this.position.x,y:this.position.y,z:this.position.z}),this.config.rotation&&(t.quaternion={x:this.quaternion.x,y:this.quaternion.y,z:this.quaternion.z,w:this.quaternion.w}),this.config.scale&&(t.scale={x:this.scale.x,y:this.scale.y,z:this.scale.z}),Object.keys(t).length>0){if(M(t,this.lastTransform))return;this.transformRef.set(t),this.lastTransform=t}}},e.prototype.takeOwnership=function(){this.ownerRef.set(this.sceneSync.clientId)},Object.defineProperties(e.prototype,n),e}(ft),Bt=[],Nt={},Ut={},zt=function(t){function e(t,e){this.config=Object.assign({instantiators:{},destroyers:{},ready:null,autoSendRateMS:100},e),this.instanceRef=t,this.sceneRef=t.child("scene"),this.clientsRef=t.child("clients"),this.clientId=null,this.masterClientId=null}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{},isMasterClient:{}};return n.type.get=function(){return"SceneSync"},e.prototype.awake=function(t,e){var n=this;setInterval(D,this.config.autoSendRateMS);var o=e;this.clientId=o.uuid,this.clientsRef.on("value",function(t){var e=t.val();if(e){var o=Object.keys(e)[0];n.masterClientId=e[o]}}.bind(this)),this.clientsRef.push(clientId).onDisconnect().remove(),this.instanceRef.child("initialized").once("value",function(t){var e=!t.val();t.ref().set(!0),n.config.ready&&n.config.ready(e)}.bind(this)),this.sceneRef.on("child_added",this.onInstantiate.bind(this)),this.sceneRef.on("child_removed",this.onDestroy.bind(this))},e.prototype.instantiate=function(t,e,n){void 0===e&&(e={});var o=this.sceneRef.push({syncType:t,initData:e},function(t){if(t)throw Error("Failed to save to Firebase",t)});n&&o.onDisconnect().remove();var i=Nt[o.key()];return i.getBehaviorByType("Object3DSync").takeOwnership(),i},e.prototype.onInstantiate=function(t){var e=t.val(),n=t.key(),o=this.instantiators[e.syncType];if(!o)return void console.warn("No instantiator found for syncType: "+e.syncType);var i=o(e.initData,e.syncType);if(!i)return void console.error(e.syncType+".create must return an Object3D");Nt[n]=i,Ut[i.uuid]=n;var s=i.getBehaviorByType("Object3DSync");return s?(Bt.push(s),void s.link(t.ref(),this)):void console.error(e.syncType+" instantiator must return an Object3D with an Object3DSync behavior")},e.prototype.destroy=function(t){var e=Ut[t.uuid];return e?(this.sceneRef.child(e).remove(function(t){t&&console.warn("Failed to remove from Firebase",t)}),void this.sceneRef.child(e).off()):void console.warn("Failed to find key for object3d to be destroyed",t)},e.prototype.onDestroy=function(t){function e(t){t.removeAllBehaviors(),t.parent&&t.parent.remove(t),t.geometry&&t.geometry.dispose(),t.material&&(t.material.map&&t.material.map.dispose(),t.material.dispose())}var n=t.val(),o=t.key(),i=Nt[o];if(!i)return void console.warn("Failed to find object matching deleted key",o);var s=n.syncType;if(!s)return void console.warn("No syncType found for object being destroyed",i);var r=this.config.destroyers[s],a=!r;r&&(a=r(i)),a&&e(i),delete Nt[o],delete Ut[i.uuid]},n.isMasterClient.get=function(){return this.masterClientId===this.clientId},Object.defineProperties(e.prototype,n),e}(ft),Vt=function(t){function e(t){this.config=Object.assign({speed:1e-4,axis:new THREE.Vector3(0,1,0)},t),this.config.axis.normalize(),this.object3d=null}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"Spin"},e.prototype.awake=function(t){this.object3d=t},e.prototype.update=function(t){this.object3d.rotateOnAxis(this.config.axis,this.config.speed*t)},Object.defineProperties(e.prototype,n),e}(ft),Ft=function(t){function e(t){this.config=Object.assign({logging:!1},t)}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"SteamVRInput"},e.prototype.awake=function(){var t=this;this.leftControllerPromise=A(e.LEFT_CONTROLLER,this.config),this.rightControllerPromise=A(e.RIGHT_CONTROLLER,this.config),this.firstControllerPromise=Promise.race([this.leftControllerPromise,this.rightControllerPromise]),this.leftControllerPromise.then(function(e){t.leftController=e}),this.rightControllerPromise.then(function(e){t.rightController=e}),this.firstControllerPromise.then(function(n){t.firstController=n;var o=n.axes.map(function(){return!1}),i=n.buttons.map(function(){return!1});i[e.BUTTON_TRIGGER]=!0,i[e.BUTTON_TOUCHPAD]=!0,n.preventDefault(o,i)})},Object.defineProperties(e.prototype,n),e}(ft);Ft.BUTTON_TRIGGER=0,Ft.BUTTON_GRIP=1,Ft.BUTTON_TOUCHPAD=2,Ft.BUTTON_DPAD_UP=3,Ft.BUTTON_DPAD_RIGHT=4,Ft.BUTTON_DPAD_DOWN=5,Ft.BUTTON_DPAD_LEFT=6,Ft.AXIS_TOUCHPAD_X=0,Ft.AXIS_TOUCHPAD_Y=1,Ft.FIRST_CONTROLLER="first",Ft.LEFT_CONTROLLER="left",Ft.RIGHT_CONTROLLER="right";var qt=function(t){function e(t){var e=t.hand;void 0===e&&(e="first"),this._hand=e}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"SteamVRTrackedObject"},e.prototype.awake=function(t,e){this._object3d=t,this._scene=e,this._steamVRInput=this._scene.getBehaviorByType("SteamVRInput")},e.prototype.update=function(){var t=this._steamVRInput[this._hand+"Controller"],e=this._object3d;if(t){var n=t.position,o=n.x,i=n.y,s=n.z;e.position.set(o,i,s);var r=t.rotation,o=r.x,i=r.y,s=r.z,a=r.w;e.quaternion.set(o,i,s,a)}},Object.defineProperties(e.prototype,n),e}(ft),Gt=function(t){function e(t){void 0===t&&(t={}),this.object3d=null,this.scene=null,this.startingRotation=null,this.activelyRotating=!1,this.lastDisplacementX=0,this.runningCount=5,this.runningAverageVelocityX=0}t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e;var n={type:{}};return n.type.get=function(){return"TouchpadRotate"},e.prototype.awake=function(t,e){this.object3d=t,this.scene=e,altspace.addEventListener("touchpadup",this.onTouchpadUp.bind(this)),altspace.addEventListener("touchpaddown",this.onTouchpadDown.bind(this)),altspace.addEventListener("touchpadmove",this.onTouchpadMove.bind(this))},e.prototype.update=function(t){!this.activelyRotating&&Math.abs(this.runningAverageVelocityX)>.01&&(this.object3d.rotation.y+=this.runningAverageVelocityX,this.runningAverageVelocityX*=.97)},e.prototype.onTouchpadUp=function(t){this.activelyRotating=!1},e.prototype.onTouchpadDown=function(t){this.activelyRotating=!0,this.startingRotation=this.object3d.rotation.clone()},e.prototype.onTouchpadMove=function(t){var e=t.displacementX-this.lastDisplacementX;this.object3d.rotation.set(this.startingRotation.x,this.startingRotation.y+t.displacementX/300,this.startingRotation.z),this.runningAverageVelocityX=(this.runningAverageVelocityX*this.runningCount+e/300)/(this.runningCount+1),this.lastDisplacementX=t.displacementX},Object.defineProperties(e.prototype,n),e}(ft),Wt=Object.freeze({Behavior:ft,Bob:yt,ButtonStateStyle:gt,Drag:bt,GamepadControls:Et,HoverColor:jt,HoverScale:wt,JointCollisionEvents:_t,Layout:Ht,Object3DSync:Pt,SceneSync:zt,Spin:Vt,SteamVRInput:Ft,SteamVRTrackedObject:qt,TouchpadRotate:Gt}),Jt=Object.freeze({sync:Z,Simulation:tt,multiloader:rt,codePen:ht,shims:ut,behaviors:Wt}),Xt="2.0.0";window.altspace&&window.altspace.requestVersion&&window.altspace.requestVersion(Xt),window.AFRAME&&!window.THREE&&(window.THREE=window.AFRAME.THREE),t.components=X,t.utilities=Jt,t.version=Xt}(this.altspace=this.altspace||{},Firebase,Url,Please);
