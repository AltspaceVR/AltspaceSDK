...
**Latest Version: v2.2.2 -- [See Changes](https://github.com/AltspaceVR/AltspaceSDK/releases/tag/v2.2.2)**

Include the latest version of the SDK in your app with:

`<script src="https://sdk.altvr.com/libs/altspace.js/2.2.2/altspace.min.js"></script>`
