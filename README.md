...
**Latest Version: v0.19.1 -- [See Changes](https://github.com/AltspaceVR/AltspaceSDK/releases/tag/v0.19.1)**  
...
`<script src="http://sdk.altvr.com/libs/altspace.js/0.19.1/altspace.min.js"></script>`
