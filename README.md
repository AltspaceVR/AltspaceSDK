...
**Latest Version: v0.24.4 -- [See Changes](https://github.com/AltspaceVR/AltspaceSDK/releases/tag/v0.24.4)**
...
`<script src="http://sdk.altvr.com/libs/altspace.js/0.24.4/altspace.min.js"></script>`
