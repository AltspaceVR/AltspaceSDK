...
**Latest Version: v0.26.2 -- [See Changes](https://github.com/AltspaceVR/AltspaceSDK/releases/tag/v0.26.2)**
...
`<script src="http://sdk.altvr.com/libs/altspace.js/0.26.2/altspace.min.js"></script>`
