...
**Latest Version: v2.5.1 -- [See Changes](https://github.com/AltspaceVR/AltspaceSDK/releases/tag/v2.5.1)**

Include the latest version of the SDK in your app with:

`<script src="https://sdk.altvr.com/libs/altspace.js/2.5.1/altspace.min.js"></script>`
