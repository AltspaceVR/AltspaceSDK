...
**Latest Version: v0.13.2 -- [See Changes](https://github.com/AltspaceVR/AltspaceSDK/releases/tag/v0.13.2)**  
...
`<script src="http://sdk.altvr.com/libs/altspace.js/0.13.2/altspace.min.js"></script>`
