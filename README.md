...
**Latest Version: v0.26.3 -- [See Changes](https://github.com/AltspaceVR/AltspaceSDK/releases/tag/v0.26.3)**
...
`<script src="http://sdk.altvr.com/libs/altspace.js/0.26.3/altspace.min.js"></script>`
