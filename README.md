...
**Latest Version: v0.22.0 -- [See Changes](https://github.com/AltspaceVR/AltspaceSDK/releases/tag/v0.22.0)**  
...
`<script src="http://sdk.altvr.com/libs/altspace.js/0.22.0/altspace.min.js"></script>`
